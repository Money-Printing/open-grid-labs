...
export default function FileUpload({ file: externalFile, onChange, label }: FileUploadProps) {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div
        className="flex flex-col items-center justify-center w-full h-48 bg-white/50 dark:bg-foreground/5 text-foreground border border-dashed border-border rounded-xl cursor-pointer hover:bg-white/50 dark:bg-foreground/10 transition-colors"
        onDrop={handleDrop}
          ...
          {file ? (
            ...
            <>
              ...
              <button
                type="button"
                onClick={handleClick}
                className="inline-flex items-center bg-foreground text-background hover:bg-white/50 dark:bg-foreground/85 font-medium rounded-lg px-4 py-2 text-sm transition-colors"
              >
                <svg
