				...
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-[90%] max-w-[1600px] mx-auto">
					...
					<div className="flex flex-col items-center lg:items-start text-center lg:text-left">
						...
						>
							...
							<span className="text-xs font-semibold uppercase tracking-widest text-primary">Next-Gen IT Solutions</span>
						</motion.div>
						...
						>
							...
							<span className="block mt-2 text-white">Digital Future</span>
						</motion.h1>
						...
						>
							<div className="relative group">
								...
								<Button
									...
									className='relative w-full sm:w-fit !bg-background border border-primary/50 !text-white hover:!bg-primary/10 h-14 px-8 text-base transition-all duration-300'
								>
									Book Call
					...
					>
						...
						>
							<div className="text-sm font-semibold text-white mb-1">Global Scale</div>
						...
						>
							<div className="text-sm font-semibold text-white mb-1">99.99%</div>
					...
					<div className="relative w-full flex items-center h-[120px] perspective-[1000px]">
						...
						>
							{[...brands, ...brands].map((b, i) => (
								<div 
									key={i} 
									className='group relative px-6 py-4 flex items-center justify-center shrink-0 transition-all duration-500 rounded-2xl hover:-translate-y-2 hover:shadow-[0_10px_30px_hsla(210,100%,50%,0.2)] bg-white/5 border border-white/5 backdrop-blur-sm shadow-[0_0_15px_rgba(0,0,0,0.5)] w-[260px] h-[90px]'
								>
