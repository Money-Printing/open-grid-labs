	...
	return (
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-primary/20 rounded-full blur-[60px] pointer-events-none" />
			<div className="flex flex-col items-center gap-4 relative z-10">
				<h1 className="font-display font-bold text-white uppercase tracking-tight flex flex-col md:flex-row items-center gap-3 md:gap-4 text-4xl md:text-7xl text-center md:text-left drop-shadow-lg">
              ...
              <div className="absolute inset-0 bg-primary/20 blur-xl rounded-full" />
							<Icon size={iconSize} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] relative z-10" />
						</motion.span>
					)}
					...
					{!hideIcon && (
						...
						>
              <div className="absolute inset-0 bg-primary/20 blur-xl rounded-full" />
							<Icon size={Math.floor(iconSize / 2)} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] relative z-10" />
						</motion.span>
					)}
