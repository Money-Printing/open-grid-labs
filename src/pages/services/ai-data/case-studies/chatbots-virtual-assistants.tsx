...
const STATS = [
	{ value: "27", label: "Support intents automated with safe handoff", accent: "from-emerald-400 to-teal-500" },
	{ value: "-39%", label: "Reduction in repetitive support contacts", accent: "from-cyan-400 to-blue-500" },
	{ value: "91%", label: "Answer coverage for approved knowledge base topics", accent: "from-purple-500 to-indigo-500" },
	{ value: "11 wk", label: "From script bot to production assistant", accent: "from-pink-500 to-rose-400" }
];
...
const PHASES = [
	...
	{
		number: "Phase 3",
		title: "Integration, Monitoring & Enablement (Weeks 8-11)",
...
const TABLE_RESULTS = [
	{ metric: "Automated support intents", before: "0", after: "27 intents", change: "New capability" },
	{ metric: "Repetitive contacts", before: "Baseline", after: "61% of baseline", change: "-39%" },
	{ metric: "Approved knowledge coverage", before: "Fragmented", after: "91% coverage", change: "Improved" },
	{ metric: "Escalation quality", before: "Manual routing", after: "Policy-based handoff", change: "Safer" },
	{ metric: "Conversation analytics", before: "Limited", after: "Full funnel reporting", change: "Visible" }
];
...
const FAQS = [
	{
		q: "What is Chatbots & Virtual Assistants?",
		a: "Chatbots & Virtual Assistants is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Chatbots & Virtual Assistants?",
		a: "Companies use Chatbots & Virtual Assistants to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function ChatbotsVirtualAssistantsCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Chatbots & Virtual Assistants Case Study | OpenGridLabs"
				description="How OpenGridLabs designed a governed conversational AI system automating 27 intents and reducing repetitive support load by 39%."
				canonical="/services/ai-data/chatbots-virtual-assistants"
				keywords="Chatbots, Virtual Assistants, Conversational AI, Customer Support AI, RAG Chatbot, Intent Routing, NLP pipeline"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
						...
						>
							<div className="flex items-center gap-3">
								<span className="text-xs md:text-sm font-bold tracking-widest uppercase px-4 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 backdrop-blur-md">
									Case Study · Chatbots & Virtual Assistants
								</span>
							</div>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Chatbots & Virtual Assistants Reduced Support Load With a Governed Conversational AI Assistant
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A customer success team partnered with OpenGridLabs to turn an experimental script bot into a production-grade conversational AI assistant—automating 27 support intents, cutting repetitive contacts by 39%, and implementing strict quality controls.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Digital support and customer success (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">27 support intents automated</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">RAG · Intent Routing · Escalation · Analytics</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Chatbots & Virtual Assistants that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground mt-2">
							Five Operational Challenges Resolved
						</h2>
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs replaced brittle script flows with governed NLP systems.
						</p>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Chatbots & Virtual Assistants Architecture Stages
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-20">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							The engagement ran across three phases over eleven weeks, moving from discovery and evaluation into production workflow integration and long-term monitoring.
						</p>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Results were measured after deployment against the client's pre-engagement baseline, comparing support load reductions, approved knowledge base coverage, and routing safety.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that chatbots & virtual assistants stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready conversational AI?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for chatbots & virtual assistants, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
