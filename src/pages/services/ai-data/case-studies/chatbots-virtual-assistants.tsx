	...
	return (
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					categoryTag="Case Study · Chatbots & Virtual Assistants"
					title="How Chatbots & Virtual Assistants Reduced Support Load With a Governed Conversational AI Assistant"
					description="A customer success team partnered with OpenGridLabs to turn an experimental script bot into a production-grade conversational AI assistant—automating 27 support intents, cutting repetitive contacts by 39%, and implementing strict quality controls."
					...
					details={[
						{ label: "Sector", value: "Digital support and customer success (anonymised)" },
						{ label: "Scope", value: "27 support intents automated" },
						{ label: "Timeline", value: "11 weeks to production" },
						{ label: "Stack", value: "RAG · Intent Routing · Escalation · Analytics" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/chatbots-virtual-assistants/1.jpg",
						"/images/case-studies/chatbots-virtual-assistants/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Are Chatbots & Virtual Assistants?"
					definitionText="Chatbots & Virtual Assistants applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<ChallengesSolutions 
					...
					title={"Five Operational Challenges Resolved"}
					description={"How OpenGridLabs replaced brittle script flows with governed NLP systems."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Chatbots & Virtual Assistants Architecture Stages"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"The engagement ran across three phases over eleven weeks, moving from discovery and evaluation into production workflow integration and long-term monitoring."}
				...
				<MeasurableResults 
					description="Results were measured after deployment against the client's pre-engagement baseline, comparing support load reductions, approved knowledge base coverage, and routing safety."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The biggest change was that chatbots & virtual assistants stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready conversational AI?"}
					description={"OpenGridLabs designs NLP systems for chatbots & virtual assistants, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
