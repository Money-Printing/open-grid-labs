	...
	return (
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					categoryTag="Case Study · Intent Recognition"
					title="How Intent Recognition Routed Customer Requests to the Right Workflow Automatically"
					description="A support and operations team partnered with OpenGridLabs to build an automated, governed intent recognition pipeline—classifying 31 customer intents, reducing manual triage time by 49%, and integrating directly with CRMs."
					...
					details={[
						{ label: "Sector", value: "Customer support and operations (anonymised)" },
						{ label: "Scope", value: "31 intents classified" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Intent Recognition?"
					definitionText="Intent Recognition applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<ChallengesSolutions 
					...
					title={"Five Operational Gaps Resolved"}
					description={"How OpenGridLabs turned ad hoc shared mailboxes into a structured routing platform."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Intent Recognition Architecture Stages"}
				/>
				...
				<MeasurableResults 
					description="Results were measured after deployment against the client's pre-engagement baseline, comparing triage speeds, intent numbers, and accuracy checks."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The biggest change was that intent recognition stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Intent Recognition?"}
					description={"OpenGridLabs designs NLP systems for intent recognition, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
