	...
	return (
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					categoryTag="Case Study · Language Translation"
					title="How Language Translation Expanded Multilingual Support Without Slowing Operations"
					description="A global SaaS operations team partnered with OpenGridLabs to build a governed language translation workflow—supporting 12 languages, cutting translation turnaround by 67%, and ensuring 94% glossary adherence."
					...
					details={[
						{ label: "Sector", value: "Global SaaS support and content operations (anonymised)" },
						{ label: "Scope", value: "12 languages supported" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Language Translation?"
					definitionText="Language Translation applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<ChallengesSolutions 
					...
					title={"Five Localization Bottlenecks Overcome"}
					description={"How OpenGridLabs built a glossary-enforced translation system to speed global expansion."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Language Translation Architecture Stages"}
				/>
				...
				<MeasurableResults 
					description="Results were measured after deployment against the client's pre-engagement baseline, comparing turnaround reductions, active languages, and glossary adherence."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The biggest change was that language translation stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Language Translation?"}
					description={"OpenGridLabs designs NLP systems for language translation, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
