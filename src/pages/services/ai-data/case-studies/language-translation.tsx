...
const STATS = [
	...
	{ value: "-67%", label: "Reduction in manual translation turnaround", accent: "from-cyan-400 to-blue-500" },
	{ value: "94%", label: "Glossary adherence on reviewed samples", accent: "from-purple-500 to-indigo-500" },
	{ value: "10 wk", label: "From manual translation to multilingual workflow", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Languages supported", before: "3 priority languages", after: "12 languages", change: "Expanded" },
	{ metric: "Translation turnaround", before: "Baseline", after: "33% of baseline", change: "-67%" },
	{ metric: "Glossary adherence", before: "Inconsistent", after: "94% reviewed adherence", change: "Improved" },
	{ metric: "Human review routing", before: "Manual", after: "Confidence-based", change: "Controlled" },
	{ metric: "Regional content reuse", before: "Low", after: "Shared translation memory", change: "Scalable" }
];
...
const FAQS = [
	{
		q: "What is Language Translation?",
		a: "Language Translation is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Language Translation?",
		a: "Companies use Language Translation to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function LanguageTranslationCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Language Translation Case Study | OpenGridLabs"
				description="How OpenGridLabs built a language translation workflow supporting 12 languages, cutting manual translation turnaround by 67%."
				canonical="/services/ai-data/language-translation"
				keywords="Language Translation, Machine Translation, Multilingual NLP, Localization Automation, Translation memory, glossary management"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Language Translation Expanded Multilingual Support Without Slowing Operations
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A global SaaS operations team partnered with OpenGridLabs to build a governed language translation workflow—supporting 12 languages, cutting translation turnaround by 67%, and ensuring 94% glossary adherence.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Global SaaS support and content operations (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">12 languages supported</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Translation Models · Glossary · Quality Review · Localization</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Language Translation that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground mt-2">
							Five Localization Bottlenecks Overcome
						</h2>
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs built a glossary-enforced translation system to speed global expansion.
						</p>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Language Translation Architecture Stages
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Results were measured after deployment against the client's pre-engagement baseline, comparing turnaround reductions, active languages, and glossary adherence.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that language translation stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Language Translation?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for language translation, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
