	...
	return (
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					categoryTag="Case Study · Named Entity Recognition"
					title="How Named Entity Recognition Extracted Critical Entities From Documents and Support Workflows"
					description="An enterprise operations team partnered with OpenGridLabs to build a precise named entity recognition pipeline—extracting 19 entity types, reducing manual data entry by 61%, and securing 88% Reviewed Match Precision."
					...
					details={[
						{ label: "Sector", value: "Enterprise operations and document processing (anonymised)" },
						{ label: "Scope", value: "19 entity types extracted" },
						{ label: "Timeline", value: "8 weeks to production" },
						{ label: "Stack", value: "NER · Entity Linking · Validation · Workflow APIs" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/named-entity-recognition/1.jpg",
						"/images/case-studies/named-entity-recognition/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Named Entity Recognition?"
					definitionText="Named Entity Recognition applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<ChallengesSolutions 
					...
					title={"Five Operations Bottlenecks Overcome"}
					description={"How OpenGridLabs automated data extraction to replace manual tagging."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Named Entity Recognition Architecture Stages"}
				/>
				...
				<MeasurableResults 
					description="Results were measured after deployment against the client's pre-engagement baseline, comparing manual data capture volumes, entity precisions, and queue updates."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The biggest change was that named entity recognition stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build Named Entity Recognition?"}
					description={"OpenGridLabs designs NLP systems for named entity recognition, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
