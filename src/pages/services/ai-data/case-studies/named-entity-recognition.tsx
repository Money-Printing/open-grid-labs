...
const STATS = [
	{ value: "19", label: "Entity types extracted from text and documents", accent: "from-emerald-400 to-teal-500" },
	{ value: "-61%", label: "Reduction in manual data capture", accent: "from-cyan-400 to-blue-500" },
	{ value: "88%", label: "Entity match precision on reviewed samples", accent: "from-purple-500 to-indigo-500" },
	{ value: "8 wk", label: "From manual tagging to entity extraction", accent: "from-pink-500 to-rose-400" }
];
...
const PHASES = [
	...
	{
		number: "Phase 3",
		title: "Integration, Monitoring & Enablement (Week 8)",
...
const TABLE_RESULTS = [
	{ metric: "Entity types extracted", before: "Manual fields", after: "19 entity types", change: "Automated" },
	{ metric: "Manual data capture", before: "Baseline", after: "39% of baseline", change: "-61%" },
	{ metric: "Entity precision", before: "Variable", after: "88% reviewed precision", change: "Improved" },
	{ metric: "System updates", before: "Manual entry", after: "API-assisted updates", change: "Faster" },
	{ metric: "Review workflow", before: "Email-based", after: "Exception queue", change: "Controlled" }
];
...
const FAQS = [
	{
		...
		a: "Named Entity Recognition is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Named Entity Recognition?",
		a: "Companies use Named Entity Recognition to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function NamedEntityRecognitionCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Named Entity Recognition Case Study | OpenGridLabs"
				description="How OpenGridLabs designed a named entity recognition pipeline supporting 19 entity types, cutting manual data capture by 61%."
				canonical="/services/ai-data/named-entity-recognition"
				keywords="Named Entity Recognition, NER, Entity Extraction, Entity Linking, document AI, information extraction, NLP pipeline"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Named Entity Recognition Extracted Critical Entities From Documents and Support Workflows
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								An enterprise operations team partnered with OpenGridLabs to build a precise named entity recognition pipeline—extracting 19 entity types, reducing manual data entry by 61%, and securing 88% Reviewed Match Precision.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Enterprise operations and document processing (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">19 entity types extracted</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">NER · Entity Linking · Validation · Workflow APIs</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Named Entity Recognition that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground mt-2">
							Five Operations Bottlenecks Overcome
						</h2>
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs automated data extraction to replace manual tagging.
						</p>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Named Entity Recognition Architecture Stages
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-20">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							The engagement ran across three phases over eight weeks, moving from discovery and evaluation into production workflow integration and long-term monitoring.
						</p>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Results were measured after deployment against the client's pre-engagement baseline, comparing manual data capture volumes, entity precisions, and queue updates.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that named entity recognition stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build Named Entity Recognition?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for named entity recognition, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
