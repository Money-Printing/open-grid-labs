		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Object Detection Located Critical Objects in Images and Video Streams"
					description="An operations team needed to identify where important objects appeared, not just whether they were present. OpenGridLabs built an object detection system that located assets, defects, safety events, and anomalies across images and video frames."
					...
					details={[
						{ label: "Sector", value: "Industrial operations and safety monitoring (anonymised)" },
						{ label: "Scope", value: "26 object classes detected" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Object Detection?"
					definitionText="Object Detection uses deep learning models to learn patterns from complex data and support prediction, recognition, generation, classification, or automation. In production, it requires curated data, model evaluation, deployment infrastructure, monitoring, and governance so outputs remain reliable over time."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Object Detection Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest shift was that object detection became something we could operate, not just test. We can see quality, handle edge cases, and improve the model without rebuilding the workflow every time."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Object Detection?"}
					description={"OpenGridLabs designs deep learning systems for object detection, including data pipelines, model training, evaluation, deployment, monitoring, human review, and integration with your existing workflows."}
