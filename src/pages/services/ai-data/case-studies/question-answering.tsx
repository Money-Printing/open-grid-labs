		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Question Answering Turned Internal Knowledge Into Reliable Answers"
					description="Employees and customers were asking the same questions across support, sales, and onboarding, but answers were scattered across documents and systems. OpenGridLabs built a question answering workflow that retrieved trusted knowledge, generated grounded answers, and routed uncertain responses for review."
					...
					details={[
						{ label: "Sector", value: "Knowledge management and customer enablement (anonymised)" },
						{ label: "Scope", value: "4 knowledge sources connected" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Question Answering?"
					definitionText="Question Answering applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs turned scattered documentation into a production-ready QA platform."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Question Answering Architecture Stages"}
				/>
				...
				<MeasurableResults 
					description="Results were measured after deployment against the client's pre-engagement baseline, comparing turnaround reductions, active knowledge sources, and reviewed query acceptance."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The biggest change was that question answering stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Question Answering?"}
					description={"OpenGridLabs designs NLP systems for question answering, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
