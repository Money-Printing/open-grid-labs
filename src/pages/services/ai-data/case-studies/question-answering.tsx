...
const STATS = [
	...
	{ value: "-57%", label: "Reduction in repeated internal questions", accent: "from-cyan-400 to-blue-500" },
	{ value: "86%", label: "Answer acceptance rate on reviewed queries", accent: "from-purple-500 to-indigo-500" },
	{ value: "10 wk", label: "From scattered docs to answer system", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Knowledge sources connected", before: "Manual search", after: "4 connected sources", change: "Unified" },
	{ metric: "Repeated internal questions", before: "Baseline", after: "43% of baseline", change: "-57%" },
	{ metric: "Answer acceptance rate", before: "Unknown", after: "86% reviewed acceptance", change: "Measured" },
	{ metric: "Citation coverage", before: "Inconsistent", after: "Source-backed answers", change: "Improved" },
	{ metric: "Uncertain answers", before: "Unhandled", after: "Review queue", change: "Safer" }
];
...
const FAQS = [
	{
		...
		a: "Question Answering is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Question Answering?",
		a: "Companies use Question Answering to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function QuestionAnsweringCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Question Answering Case Study | OpenGridLabs"
				description="How OpenGridLabs built a question answering workflow connecting 4 knowledge sources, cutting repeated internal questions by 57%."
				canonical="/services/ai-data/question-answering"
				keywords="Question Answering, RAG, NLP retrieval, Enterprise Search, Grounded Answers, Chatbots, AI Helpdesk"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Question Answering Turned Internal Knowledge Into Reliable Answers
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								Employees and customers were asking the same questions across support, sales, and onboarding, but answers were scattered across documents and systems. OpenGridLabs built a question answering workflow that retrieved trusted knowledge, generated grounded answers, and routed uncertain responses for review.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Knowledge management and customer enablement (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">4 knowledge sources connected</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Retrieval · Answer Generation · Citations · Feedback Loop</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Question Answering that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs turned scattered documentation into a production-ready QA platform.
						</p>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Question Answering Architecture Stages
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-20">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							The engagement ran across three phases over ten weeks, moving from discovery and evaluation into production workflow integration and long-term monitoring.
						</p>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Results were measured after deployment against the client's pre-engagement baseline, comparing turnaround reductions, active knowledge sources, and reviewed query acceptance.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that question answering stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Question Answering?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for question answering, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
