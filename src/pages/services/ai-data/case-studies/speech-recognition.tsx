...
const STATS = [
	...
	{ value: "-59%", label: "Reduction in manual call note preparation", accent: "from-cyan-400 to-blue-500" },
	{ value: "87%", label: "Transcript usability score on reviewed samples", accent: "from-purple-500 to-indigo-500" },
	{ value: "11 wk", label: "From audio archive to searchable transcripts", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Audio minutes processed", before: "Manual notes", after: "220k minutes", change: "Scaled" },
	{ metric: "Call note preparation", before: "Baseline", after: "41% of baseline", change: "-59%" },
	{ metric: "Transcript usability", before: "Unknown", after: "87% reviewed score", change: "Measured" },
	{ metric: "Searchable call history", before: "Limited", after: "Unified transcript index", change: "New capability" },
	{ metric: "Quality review", before: "Manual sampling", after: "Confidence-based QA", change: "Controlled" }
];
...
const FAQS = [
	{
		...
		a: "Speech Recognition is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Speech Recognition?",
		a: "Companies use Speech Recognition to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function SpeechRecognitionCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Speech Recognition Case Study | OpenGridLabs"
				description="How OpenGridLabs built a speech recognition workflow that transcribed 220k audio minutes, cut manual call note preparation by 59%, and achieved an 87% transcript usability score."
				canonical="/services/ai-data/speech-recognition"
				keywords="Speech Recognition, Automatic Speech Recognition, ASR, Call Transcription, Voice Analytics, Audio to Text, Contact Center AI, Transcript Analytics, Speaker Labels, Voice Notes"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Speech Recognition Converted Calls and Voice Notes Into Searchable Workflow Data
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A service organization had valuable customer conversations locked inside calls and voice notes. OpenGridLabs built a speech recognition workflow that transcribed audio, identified speakers, extracted key events, and connected transcripts to support and analytics systems.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Contact center and field operations (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">220k audio minutes processed</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">ASR · Speaker Labels · Transcript QA · Analytics</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Speech Recognition that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground mt-2">
							Five Audio Workflow Gaps Resolved
						</h2>
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs turned locked customer conversations into a searchable, structured transcript platform.
						</p>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Speech Recognition Architecture Stages
								</h3>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that speech recognition stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Speech Recognition?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for speech recognition, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
