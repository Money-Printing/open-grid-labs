		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Speech Recognition Converted Calls and Voice Notes Into Searchable Workflow Data"
					description="A service organization had valuable customer conversations locked inside calls and voice notes. OpenGridLabs built a speech recognition workflow that transcribed audio, identified speakers, extracted key events, and connected transcripts to support and analytics systems."
					...
					details={[
						{ label: "Sector", value: "Contact center and field operations (anonymised)" },
						{ label: "Scope", value: "220k audio minutes processed" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Speech Recognition?"
					definitionText="Speech Recognition applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<ChallengesSolutions 
					...
					title={"Five Audio Workflow Gaps Resolved"}
					description={"How OpenGridLabs turned locked customer conversations into a searchable, structured transcript platform."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Speech Recognition Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest change was that speech recognition stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Speech Recognition?"}
					description={"OpenGridLabs designs NLP systems for speech recognition, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
