		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Style Transfer Automated Branded Visual Variants Without Rebuilding Creative Workflows"
					description="A creative team needed to adapt images into different brand styles, campaign looks, and product presentation formats without starting from scratch. OpenGridLabs built a style transfer workflow with reference libraries, review gates, and asset delivery controls."
					...
					details={[
						{ label: "Sector", value: "Creative operations and ecommerce content (anonymised)" },
						{ label: "Scope", value: "12 style families supported" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Style Transfer?"
					definitionText="Style Transfer uses deep learning models to learn patterns from complex data and support prediction, recognition, generation, classification, or automation. In production, it requires curated data, model evaluation, deployment infrastructure, monitoring, and governance so outputs remain reliable over time."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Style Transfer Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest shift was that style transfer became something we could operate, not just test. We can see quality, handle edge cases, and improve the model without rebuilding the workflow every time."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Style Transfer?"}
					description={"OpenGridLabs designs deep learning systems for style transfer, including data pipelines, model training, evaluation, deployment, monitoring, human review, and integration with your existing workflows."}
