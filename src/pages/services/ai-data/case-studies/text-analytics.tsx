...
const STATS = [
	{ value: "1.8M", label: "Historical text records indexed and enriched", accent: "from-emerald-400 to-teal-500" },
	{ value: "-58%", label: "Reduction in manual review effort", accent: "from-cyan-400 to-blue-500" },
	{ value: "34", label: "Business-ready text categories created", accent: "from-purple-500 to-indigo-500" },
	{ value: "9 wk", label: "From raw text to analytics workflow", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Text records analyzed", before: "Manual samples", after: "1.8M indexed records", change: "Scaled" },
	{ metric: "Manual review effort", before: "Baseline", after: "42% of baseline", change: "-58%" },
	{ metric: "Topic and issue visibility", before: "Anecdotal", after: "Dashboard coverage", change: "Operational" },
	{ metric: "Searchable text history", before: "Limited", after: "Unified index", change: "New capability" },
	{ metric: "Reporting cycle", before: "Several days", after: "Same-day reporting", change: "Faster" }
];
...
const FAQS = [
	{
		...
		a: "Text Analytics is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Text Analytics?",
		a: "Companies use Text Analytics to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function TextAnalyticsCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Text Analytics Case Study | OpenGridLabs"
				description="How OpenGridLabs built a text analytics pipeline processing 1.8M text records, cutting manual review effort by 58% and creating 34 business-ready categories."
				canonical="/services/ai-data/text-analytics"
				keywords="Text Analytics, NLP Analytics, Customer Feedback Analysis, Text Mining, Unstructured Data, Support Analytics, Voice of Customer, NLP Dashboards"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Text Analytics Turned Unstructured Text Into Searchable Business Intelligence
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A support and product organization had thousands of messages, tickets, reviews, and survey responses, but no reliable way to quantify what customers were saying. OpenGridLabs built a text analytics pipeline that transformed messy language data into searchable themes, metrics, and operational dashboards.
							</p>
						</motion.div>
						...
						>
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								<div className="absolute -top-12 -right-12 w-32 h-32 blur-3xl opacity-20 pointer-events-none rounded-full bg-emerald-500" />
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">B2B SaaS customer operations (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">1.8M text records processed</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">NLP Pipeline · Classification · Dashboards · Search</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Text Analytics that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>

						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-emerald-955/20 via-background to-background shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							...
							<div className="space-y-6 relative z-10">
								...
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Text Analytics applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration.
								</p>
							</div>
						</div>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground mt-2">
							Five Practical Gaps Resolved
						</h2>
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs turned unstructured customer messages into a searchable, categorized intelligence platform.
						</p>
					</div>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							<div className="lg:col-span-5 space-y-6">
								...
								<div className="w-16 h-1 rounded-full bg-emerald-400" />
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									OpenGridLabs designed a production NLP architecture that connected data intake, language processing, model inference, quality review, and downstream workflow actions. The result was a reusable pattern that could scale across channels and use cases.
								</p>
								...
								<div className="flex items-start gap-4 p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 text-emerald-300">
									...
									<p className="text-sm font-medium leading-relaxed">
										<strong>Design for reviewability as much as automation:</strong> The implementation focused on making outputs explainable, auditable, and easy to override. That gave teams confidence to use NLP automation in live workflows without losing control of edge cases.
									</p>
								</div>
							</div>
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Text Analytics Architecture Stages
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-20">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							The engagement ran across three phases over nine weeks, moving from discovery and evaluation into production workflow integration and long-term monitoring.
						</p>
					</div>
					...
					<div className="relative border-l border-white/10 md:border-l-0 md:flex md:flex-row gap-8 space-y-12 md:space-y-0 md:justify-between items-stretch">
						...
						<div className="hidden md:block absolute left-0 right-0 top-10 h-[2px] bg-gradient-to-r from-emerald-500 via-cyan-400 to-pink-500 opacity-20" />
						...
						{PHASES.map((phase, idx) => (
							...
							>
								<div 
									...
									style={{ backgroundImage: `linear-gradient(to right, ${idx === 0 ? "hsl(150,100%,45%)" : idx === 1 ? "hsl(180,100%,50%)" : "hsl(330,100%,60%)"}, transparent)` }}
								/>
								<div className="space-y-6">
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Results were measured after deployment against the client's pre-engagement baseline. The strongest gains came from making language workflows measurable, repeatable, and connected to operational systems.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that text analytics stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
							<div className="w-12 h-px bg-emerald-400 mx-auto" />
							<div>
								<p className="font-bold text-lg text-foreground">— Director of Operations</p>
								<p className="text-sm text-muted-foreground">Confidential Client</p>
							</div>
						</div>
					</div>
				</section>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Text Analytics?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for text analytics, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
							<div className="flex flex-col sm:flex-row justify-center items-center gap-4">
								<Link 
									to="/contact-us"
									className="px-8 py-4 rounded-full font-bold uppercase tracking-wider text-sm transition-all duration-300 shadow-lg text-white bg-gradient-to-r from-emerald-400 to-cyan-500 hover:shadow-emerald-400/20"
									style={{ 
