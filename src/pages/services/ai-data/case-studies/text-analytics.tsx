		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Text Analytics Turned Unstructured Text Into Searchable Business Intelligence"
					description="A support and product organization had thousands of messages, tickets, reviews, and survey responses, but no reliable way to quantify what customers were saying. OpenGridLabs built a text analytics pipeline that transformed messy language data into searchable themes, metrics, and operational dashboards."
					...
					details={[
						{ label: "Sector", value: "B2B SaaS customer operations (anonymised)" },
						{ label: "Scope", value: "1.8M text records processed" },
						{ label: "Timeline", value: "9 weeks to production" },
						{ label: "Stack", value: "NLP Pipeline · Classification · Dashboards · Search" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/text-analytics/1.jpg",
						"/images/case-studies/text-analytics/2.jpg"
					]}
				/>
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Text Analytics Architecture Stages"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"The engagement ran across three phases over nine weeks, moving from discovery and evaluation into production workflow integration and long-term monitoring."}
				...
				<CaseStudyQuote 
					quote={"The biggest change was that text analytics stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Text Analytics?"}
					description={"OpenGridLabs designs NLP systems for text analytics, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
