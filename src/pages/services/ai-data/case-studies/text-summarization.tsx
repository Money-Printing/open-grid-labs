...
const STATS = [
	...
	{ value: "-64%", label: "Reduction in reading and prep time", accent: "from-cyan-400 to-blue-500" },
	{ value: "89%", label: "Reviewer approval rate for generated summaries", accent: "from-purple-500 to-indigo-500" },
	{ value: "9 wk", label: "From manual reading to summary workflow", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Document types summarized", before: "0", after: "6 types", change: "New capability" },
	{ metric: "Reading and prep time", before: "Baseline", after: "36% of baseline", change: "-64%" },
	{ metric: "Summary approval rate", before: "Manual only", after: "89% approved", change: "Trusted" },
	{ metric: "Key risk visibility", before: "Buried in text", after: "Structured fields", change: "Improved" },
	{ metric: "Team handoff quality", before: "Variable", after: "Standard summaries", change: "Consistent" }
];
...
const FAQS = [
	{
		...
		a: "Text Summarization is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Text Summarization?",
		a: "Companies use Text Summarization to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function TextSummarizationCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Text Summarization Case Study | OpenGridLabs"
				description="How OpenGridLabs built a text summarization workflow summarizing 6 document types, cutting reading time by 64%, and achieving an 89% approval rate."
				canonical="/services/ai-data/text-summarization"
				keywords="Text Summarization, Document Summarization, Transcript Summaries, LLM Summaries, NLP Automation, Knowledge Extraction, Support Summaries, AI Document Processing"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Text Summarization Compressed Long Documents Into Decision-Ready Summaries
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								An operations team spent hours reading long tickets, call transcripts, documents, and account histories before taking action. OpenGridLabs built a text summarization workflow that produced structured summaries, key facts, risks, and next steps with human review for sensitive cases.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Operations, support, and account management (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">6 document types summarized</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">LLM Summaries · Extraction · Review · Workflow Integration</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Text Summarization that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Text Summarization Architecture Stages
								</h3>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that text summarization stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Text Summarization?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for text summarization, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
