		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Text Summarization Compressed Long Documents Into Decision-Ready Summaries"
					description="An operations team spent hours reading long tickets, call transcripts, documents, and account histories before taking action. OpenGridLabs built a text summarization workflow that produced structured summaries, key facts, risks, and next steps with human review for sensitive cases."
					...
					details={[
						{ label: "Sector", value: "Operations, support, and account management (anonymised)" },
						{ label: "Scope", value: "6 document types summarized" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Text Summarization?"
					definitionText="Text Summarization applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Text Summarization Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest change was that text summarization stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Text Summarization?"}
					description={"OpenGridLabs designs NLP systems for text summarization, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
