		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Transfer Learning Delivered Accurate Models Faster With Reusable Pretrained Foundations"
					description="A team needed strong model performance without months of labeled data collection for every new use case. OpenGridLabs used transfer learning to adapt pretrained models to domain-specific images, documents, and product workflows with smaller labeled datasets and faster iteration."
					...
					details={[
						{ label: "Sector", value: "Product AI and analytics engineering (anonymised)" },
						{ label: "Scope", value: "7 domain models adapted" },
						{ label: "Timeline", value: "8 weeks to production" },
						{ label: "Stack", value: "Transfer Learning · Pretrained Models · Fine-Tuning · Evaluation" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/transfer-learning/1.jpg",
						"/images/case-studies/transfer-learning/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Transfer Learning?"
					definitionText="Transfer Learning uses deep learning models to learn patterns from complex data and support prediction, recognition, generation, classification, or automation. In production, it requires curated data, model evaluation, deployment infrastructure, monitoring, and governance so outputs remain reliable over time."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Transfer Learning Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest shift was that transfer learning became something we could operate, not just test. We can see quality, handle edge cases, and improve the model without rebuilding the workflow every time."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Transfer Learning?"}
					description={"OpenGridLabs designs deep learning systems for transfer learning, including data pipelines, model training, evaluation, deployment, monitoring, human review, and integration with your existing workflows."}
