		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Video Analytics Turned Video Streams Into Operational Intelligence"
					description="A distributed operations team had video footage but no scalable way to detect events, count activity, or review exceptions. OpenGridLabs built a video analytics pipeline that sampled streams, detected events, summarized activity, and created alerts for human review."
					...
					details={[
						{ label: "Sector", value: "Retail, logistics, and field operations (anonymised)" },
						{ label: "Scope", value: "180 video streams analyzed" },
						{ label: "Timeline", value: "14 weeks to production" },
						{ label: "Stack", value: "Video Analytics · Event Detection · Frame Sampling · Alerts" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/video-analytics/1.jpg",
						"/images/case-studies/video-analytics/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Video Analytics?"
					definitionText="Video Analytics uses deep learning models to learn patterns from complex data and support prediction, recognition, generation, classification, or automation. In production, it requires curated data, model evaluation, deployment infrastructure, monitoring, and governance so outputs remain reliable over time."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Video Analytics Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest shift was that video analytics became something we could operate, not just test. We can see quality, handle edge cases, and improve the model without rebuilding the workflow every time."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Video Analytics?"}
					description={"OpenGridLabs designs deep learning systems for video analytics, including data pipelines, model training, evaluation, deployment, monitoring, human review, and integration with your existing workflows."}
