...
const STATS = [
	{ value: "180", label: "Video streams connected to analytics workflow", accent: "from-emerald-400 to-teal-500" },
	{ value: "-54%", label: "Reduction in manual footage review", accent: "from-cyan-400 to-blue-500" },
	{ value: "29", label: "Operational events detected and tracked", accent: "from-purple-500 to-indigo-500" },
	{ value: "14 wk", label: "From footage archive to video intelligence", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Video streams analyzed", before: "Manual viewing", after: "180 streams", change: "Connected" },
	{ metric: "Manual footage review", before: "Baseline", after: "46% of baseline", change: "-54%" },
	{ metric: "Event types tracked", before: "Ad hoc notes", after: "29 event types", change: "Structured" },
	{ metric: "Alert latency", before: "After review", after: "Near-real-time alerts", change: "Faster" },
	{ metric: "Operations dashboard", before: "None", after: "Live event dashboard", change: "New capability" }
];
...
const FAQS = [
	{
		...
		a: "Video Analytics is a deep learning capability that uses neural models to learn patterns from complex data such as images, video, text, sequences, or structured events. It can support recognition, prediction, generation, automation, and decision support depending on the business workflow."
	},
	{
		q: "Why do companies use Video Analytics?",
		a: "Companies use Video Analytics to automate complex analysis, improve decision speed, reduce manual review, and unlock value from data that is difficult to process with rules alone. Production success depends on data quality, evaluation, integration, monitoring, and governance."
	}
];

export default function VideoAnalyticsCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Video Analytics Case Study | OpenGridLabs"
				description="How OpenGridLabs built a video analytics pipeline to analyze 180 video streams, reducing manual footage review by 54% and enabling near-real-time event alerts."
				canonical="/services/ai-data/video-analytics"
				keywords="Video Analytics, Video AI, Event Detection, Computer Vision, Operational Intelligence, Video Monitoring, Deep Learning Video, AI Alerts"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Video Analytics Turned Video Streams Into Operational Intelligence
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A distributed operations team had video footage but no scalable way to detect events, count activity, or review exceptions. OpenGridLabs built a video analytics pipeline that sampled streams, detected events, summarized activity, and created alerts for human review.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Retail, logistics, and field operations (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">180 video streams analyzed</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Video Analytics · Event Detection · Frame Sampling · Alerts</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Video Analytics that could move beyond a promising prototype and operate reliably in a production environment. OpenGridLabs designed the deep learning workflow, data pipelines, evaluation process, deployment pattern, and monitoring needed to make the capability dependable at scale.
							</p>
						</div>
						...
						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-purple-950/20 via-background to-background shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							...
							<div className="space-y-6 relative z-10">
								...
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Video Analytics uses deep learning models to learn patterns from complex data and support prediction, recognition, generation, classification, or automation. In production, it requires curated data, model evaluation, deployment infrastructure, monitoring, and governance so outputs remain reliable over time.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Video Analytics Architecture Stages
								</h3>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest shift was that video analytics became something we could operate, not just test. We can see quality, handle edge cases, and improve the model without rebuilding the workflow every time."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Video Analytics?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs deep learning systems for video analytics, including data pipelines, model training, evaluation, deployment, monitoring, human review, and integration with your existing workflows.
							</p>
