		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Voice Synthesis Created Consistent Voice Experiences for Customer Workflows"
					description="A product team needed natural voice output for onboarding, notifications, and accessibility workflows, but manual recordings were slow to update and hard to localize. OpenGridLabs built a voice synthesis system with brand voice controls, script review, audio QA, and deployment APIs."
					...
					details={[
						{ label: "Sector", value: "Product experience and accessibility teams (anonymised)" },
						{ label: "Scope", value: "7 voice experiences launched" },
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Voice Synthesis Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The biggest change was that voice synthesis stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready Voice Synthesis?"}
					description={"OpenGridLabs designs NLP systems for voice synthesis, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use."}
