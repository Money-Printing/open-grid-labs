...
const STATS = [
	...
	{ value: "-68%", label: "Reduction in audio production turnaround", accent: "from-cyan-400 to-blue-500" },
	{ value: "93%", label: "Script-to-audio consistency in QA checks", accent: "from-purple-500 to-indigo-500" },
	{ value: "9 wk", label: "From manual recordings to voice synthesis workflow", accent: "from-pink-500 to-rose-400" }
];
...
const TABLE_RESULTS = [
	{ metric: "Voice workflows launched", before: "Manual recordings", after: "7 workflows", change: "Expanded" },
	{ metric: "Audio turnaround", before: "Baseline", after: "32% of baseline", change: "-68%" },
	{ metric: "Script consistency", before: "Manual QA", after: "93% QA consistency", change: "Improved" },
	{ metric: "Localization readiness", before: "Slow rerecording", after: "Reusable voice pipeline", change: "Scalable" },
	{ metric: "Audio release control", before: "File handoff", after: "API delivery", change: "Operational" }
];
...
const FAQS = [
	{
		...
		a: "Voice Synthesis is an NLP capability that uses language models, rules, and workflow logic to process text or speech and return useful structured outputs. It can support automation, analytics, search, routing, content creation, or customer-facing product experiences depending on the use case."
	},
	{
		q: "Why do companies use Voice Synthesis?",
		a: "Companies use Voice Synthesis to reduce manual language work, improve consistency, speed up decisions, and extract value from unstructured text or speech. The best implementations combine model automation with evaluation, monitoring, governance, and human review for sensitive cases."
	}
];

export default function VoiceSynthesisCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Voice Synthesis Case Study | OpenGridLabs"
				description="How OpenGridLabs built a voice synthesis workflow launching 7 voice-enabled experiences, cutting audio production turnaround by 68%, and achieving 93% QA consistency."
				canonical="/services/ai-data/voice-synthesis"
				keywords="Voice Synthesis, Text to Speech, TTS, Synthetic Voice, Voice AI, Accessibility Audio, Voice UX, Audio Generation"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Voice Synthesis Created Consistent Voice Experiences for Customer Workflows
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A product team needed natural voice output for onboarding, notifications, and accessibility workflows, but manual recordings were slow to update and hard to localize. OpenGridLabs built a voice synthesis system with brand voice controls, script review, audio QA, and deployment APIs.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Product experience and accessibility teams (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">7 voice experiences launched</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Text to Speech · Voice QA · Localization · Delivery APIs</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Voice Synthesis that could move beyond a prototype and support real operational decisions. OpenGridLabs designed the NLP workflow, quality controls, integrations, and monitoring needed to make the capability reliable in production.
							</p>
						</div>
						...
						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-emerald-950/20 via-background to-background shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							...
							<div className="space-y-6 relative z-10">
								...
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Voice Synthesis applies natural language processing to turn text or speech into structured outputs that software teams can search, route, summarize, score, translate, answer, generate, or act on. In production, it requires data preparation, model evaluation, quality controls, monitoring, and workflow integration.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Voice Synthesis Architecture Stages
								</h3>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The biggest change was that voice synthesis stopped being an experiment and became part of the way work moved through the business. The system gave us speed, consistency, and enough visibility to trust the outputs."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build production-ready Voice Synthesis?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs NLP systems for voice synthesis, including data pipelines, model workflows, evaluation, human review, monitoring, and integrations with the tools your teams already use.
							</p>
