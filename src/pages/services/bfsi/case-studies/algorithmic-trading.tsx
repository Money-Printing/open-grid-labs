			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How a Custom Algorithmic Trading Platform Reduced Market Impact by 34 Basis Points and Cut Execution Cost 28%
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								An asset manager executing $6B annually in equity orders was relying on broker algorithms for execution — paying a premium for access to algorithms whose logic was opaque and whose performance was unmeasured. OpenGridLabs built a proprietary execution platform: VWAP, TWAP, and implementation shortfall algorithms, a backtesting infrastructure to optimise parameters, and direct market access connectivity — reducing average market impact by 34 basis points and cutting execution cost 28%.
							</p>
						</motion.div>
						...
						>
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									...
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Execution Volume</span>
										<span className="text-base font-semibold text-foreground">$6B annual equity execution</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Low-latency execution · FIX protocol · Backtesting · Co-location · Smart order routing</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							Eliminating opaque broker execution, measuring slippage, and optimizing algorithm parameters with low-latency access.
						</p>
					</div>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							<div className="lg:col-span-5 space-y-6">
								...
								<div className="w-16 h-1 rounded-full bg-emerald-400" />
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Co-located exchange gateways connected to low-latency order routing networks, strategies, and transaction cost analysis pipelines.
								</p>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-20">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							A systematic 3-phase roadmap leading from initial gateways implementation to algorithm tuning and live execution transition.
						</p>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Reducing implementation shortfall to benchmark standards and eliminating costly broker commissions.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"We were paying brokers to execute orders using algorithms we couldn't see, measuring performance we couldn't quantify. The proprietary platform gave us control and visibility simultaneously. The 34 basis point improvement on $6B is not a rounding error."
							</p>
							<div className="w-12 h-px bg-emerald-400 mx-auto" />
							<div>
								<p className="font-bold text-lg text-foreground">— Head of Trading</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Paying for broker algorithms with no visibility into execution quality?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs builds algorithmic trading platforms — VWAP, TWAP, implementation shortfall, backtesting, and TCA — that give you control over execution cost and the data to optimise it.
							</p>
