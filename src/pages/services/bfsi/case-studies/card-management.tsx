			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">B2B Fintech (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scale</span>
										<span className="text-base font-semibold text-foreground">Cards platform for 8,000+ business clients</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Timeline</span>
										<span className="text-base font-semibold text-foreground">8 weeks MVP · 6 months full feature</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Stack</span>
										<span className="text-base font-semibold text-foreground">Card issuing API · BIN sponsor · Tokenisation · 3DS2 · Mastercard/Visa</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							Overcoming compliance overhead, program limitations, and latency in core transaction routing.
						</p>
					</div>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							<div className="lg:col-span-5 space-y-6">
								...
								<div className="w-16 h-1 rounded-full bg-amber-400" />
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									A secure, compliant transaction processing flow spanning instant issuance, spend controls, real-time auth, and card lifecycle management.
								</p>
										...
										>
											...
											<div className="md:w-1/4">
												<h4 className="font-bold uppercase tracking-wider text-sm text-foreground flex items-center gap-2">
													...
													{idx === 2 && <ShieldCheck className="w-4 h-4" style={{ color: stage.color }} />}
													{idx === 3 && <Database className="w-4 h-4" style={{ color: stage.color }} />}
													{stage.title}
												</h4>
											</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-20">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							A phased approach separating the regulatory and network access problem from the core card management product.
						</p>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="mb-12 text-center lg:text-left">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl">
							Deploying BIN sponsor platform integrations significantly cut fraud and simplified corporate spend management.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"We'd been trying to launch cards for over a year. The BIN sponsor route with OpenGridLabs building the platform took eight weeks. The speed was transformational for our clients, and the fraud reduction from 3DS2 alone justified the entire platform investment."
							</p>
							<div className="w-12 h-px bg-amber-400 mx-auto" />
							<div>
								<p className="font-bold text-lg text-foreground">— CEO</p>
								<p className="text-sm text-muted-foreground font-medium">Confidential B2B Fintech Company</p>
							</div>
						</div>
					</div>
				</section>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Card product launch stuck in 18-month bank programme timelines?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs builds card management platforms — BIN sponsor partnerships, instant virtual issuance, granular spend controls, and 3DS2 authentication — launching in weeks, not months.
							</p>
