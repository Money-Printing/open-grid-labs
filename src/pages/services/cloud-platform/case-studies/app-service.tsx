...
const STATS = [
	...
	{ value: "46%", label: "Reduction in hosting maintenance effort", accent: "from-purple-500 to-indigo-600" },
	{ value: "34%", label: "Faster deployment cycle with slots", accent: "from-blue-500 to-cyan-600" },
	{ value: "9 wk", label: "From managed servers to App Service platform", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Web apps migrated", before: "Manual hosting", after: "11 App Service apps", change: "Migrated" },
	{ metric: "Hosting maintenance", before: "Baseline", after: "54% of baseline", change: "-46%" },
	{ metric: "Deployment cycle", before: "Baseline", after: "1.34x faster", change: "Faster" },
	{ metric: "TLS and identity", before: "Manual config", after: "Managed policies", change: "Improved" },
	{ metric: "Rollback readiness", before: "Manual restores", after: "Deployment slots", change: "Safer" }
];
...
const FAQS = [
	{
		...
		a: "App Service is an Azure capability used to support production workloads through cloud compute, storage, networking, identity, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in App Service?",
		a: "Companies invest in App Service to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Microsoft Azure. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function AppServiceCaseStudy() {
	return (
		<>
			<SEO
				title="Azure App Service Case Study | OpenGridLabs"
				description="How OpenGridLabs migrated 11 web applications to Azure App Service, streamlining deployment slots, autoscale rules, and cutting hosting maintenance effort by 46%."
				canonical="/services/cloud-platform/app-service"
				keywords="App Service, Azure App Service, Web App Hosting, Deployment Slots, Managed Identity, Azure Web Apps, PaaS Hosting, Cloud Web App, DevOps, Microsoft Azure, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How App Service Modernized Web App Hosting With Managed Operations"
					description="A web platform was hosted on manually managed servers that slowed releases and created maintenance overhead. OpenGridLabs migrated key web workloads to Azure App Service with deployment slots, scaling rules, managed identity, TLS, diagnostics, and monitoring."
					...
					details={[
						{ label: "Sector", value: "Customer-facing SaaS web platform (anonymised)" },
						{ label: "Scope", value: "11 apps migrated" },
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed App Service that could move beyond a tactical cloud setup and become part of a reliable Azure operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.",
						"App Service is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is App Service?"
					definitionText="App Service is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"App Service Architecture Layers"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"A ten-week progressive roadmap moving from cloud assessment and blueprinting to infrastructure automation and operational handoff."}
				...
				<MeasurableResults 
					description="Migrating to Azure App Service reduced hosting maintenance effort, accelerated deployment cycles, and introduced robust deployment slot rollbacks."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The Azure work gave us a foundation we could actually operate. App Service stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta 
					title={"Ready to improve your Azure foundation with App Service?"}
					description={"OpenGridLabs designs and builds Azure cloud systems for app service, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
