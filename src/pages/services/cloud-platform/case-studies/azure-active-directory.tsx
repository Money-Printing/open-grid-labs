...
const STATS = [
	...
	{ value: "68%", label: "Reduction in shared or overprivileged access", accent: "from-purple-500 to-indigo-600" },
	{ value: "100%", label: "Privileged roles mapped to named owners", accent: "from-blue-500 to-cyan-600" },
	{ value: "8 wk", label: "From fragmented identity to governed access", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "SSO apps", before: "Mixed login paths", after: "12 integrated apps", change: "Unified" },
	{ metric: "Overprivileged access", before: "Baseline", after: "32% of baseline", change: "-68%" },
	{ metric: "Privileged role ownership", before: "Unclear", after: "100% owner mapping", change: "Traceable" },
	{ metric: "Access reviews", before: "Ad hoc", after: "Scheduled reviews", change: "Improved" },
	{ metric: "Audit visibility", before: "Partial logs", after: "Central audit reporting", change: "Operational" }
];
...
const FAQS = [
	{
		...
		a: "Azure Active Directory is an Azure capability used to support production workloads through cloud compute, storage, networking, identity, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Azure Active Directory?",
		a: "Companies invest in Azure Active Directory to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Microsoft Azure. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function AzureActiveDirectoryCaseStudy() {
	return (
		<>
			<SEO
				title="Azure Active Directory Case Study | OpenGridLabs"
				description="How OpenGridLabs unified cloud access and identity governance under Azure Active Directory, integrating 12 apps with SSO and reducing shared access by 68%."
				canonical="/services/cloud-platform/azure-active-directory"
				keywords="Azure Active Directory, Azure AD, Microsoft Entra ID, SSO, Conditional Access, Identity Management, Access Reviews, Cloud Identity, Microsoft Azure, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Azure Active Directory Centralized Identity and Access Across Cloud Workflows"
					description="A growing company had fragmented user access, shared admin accounts, and inconsistent app permissions. OpenGridLabs strengthened Azure Active Directory usage with role separation, SSO, conditional access, audit logs, group governance, and access reviews."
					...
					details={[
						{ label: "Sector", value: "Enterprise SaaS and internal operations (anonymised)" },
						{ label: "Scope", value: "12 apps integrated with SSO" },
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Azure Active Directory that could move beyond a tactical cloud setup and become part of a reliable Azure operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.",
						"Azure Active Directory is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Azure Active Directory?"
					definitionText="Azure Active Directory is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Azure Active Directory Architecture Layers"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"An eight-week transition plan migrating from fragmented identity controls to a governed centralized Access system."}
				...
				<MeasurableResults 
					description="Unifying cloud workloads under Azure Active Directory SSO eliminated fragmented paths, locked down role mappings, and structured audit logs."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The Azure work gave us a foundation we could actually operate. Azure Active Directory stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta 
					title={"Ready to improve your Azure foundation with Azure Active Directory?"}
					description={"OpenGridLabs designs and builds Azure cloud systems for azure active directory, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
