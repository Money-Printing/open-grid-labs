...
const STATS = [
	...
	{ value: "52%", label: "Reduction in manual release steps", accent: "from-purple-500 to-indigo-600" },
	{ value: "37%", label: "Faster deployment cycle for covered services", accent: "from-blue-500 to-cyan-600" },
	{ value: "9 wk", label: "From manual releases to Azure DevOps pipeline", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Pipelines standardized", before: "Manual scripts", after: "14 pipelines", change: "Standardized" },
	{ metric: "Manual release steps", before: "Baseline", after: "48% of baseline", change: "-52%" },
	{ metric: "Deployment cycle", before: "Baseline", after: "1.37x faster", change: "Faster" },
	{ metric: "Release approvals", before: "Chat-based approval", after: "Pipeline gates", change: "Controlled" },
	{ metric: "Artifact traceability", before: "Partial", after: "Versioned artifacts", change: "Auditable" }
];
...
const FAQS = [
	{
		...
		a: "Azure DevOps is an Azure capability used to support production workloads through cloud compute, storage, networking, identity, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Azure DevOps?",
		a: "Companies invest in Azure DevOps to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Microsoft Azure. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function AzureDevOpsCaseStudy() {
	return (
		<>
			<SEO
				title="Azure DevOps Case Study | OpenGridLabs"
				description="How OpenGridLabs standardized delivery pipelines across product teams with Azure DevOps, creating 14 CI/CD pipelines and cutting manual release steps by 52%."
				canonical="/services/cloud-platform/azure-devops"
				keywords="Azure DevOps, Azure Pipelines, CI/CD, Release Automation, DevOps Pipelines, Build Pipelines, Deployment Gates, Software Delivery, Microsoft Azure, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Azure DevOps Standardized Delivery Pipelines Across Product Teams"
					description="A software team had inconsistent build, test, release, and environment workflows across services. OpenGridLabs implemented Azure DevOps pipelines with branch policies, automated tests, deployment approvals, artifacts, and release dashboards."
					...
					details={[
						{ label: "Sector", value: "SaaS product engineering organization (anonymised)" },
						{ label: "Scope", value: "14 pipelines standardized" },
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Azure DevOps that could move beyond a tactical cloud setup and become part of a reliable Azure operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.",
						"Azure DevOps is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Azure DevOps?"
					definitionText="Azure DevOps is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<CaseStudyArchitecture 
					...
					tag={"Blueprint"}
					title={"Azure DevOps Architecture"}
					...
					rightColumnTitle={"Azure DevOps Architecture Layers"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"A nine-week delivery roadmap establishing target architecture pipelines, securing artifacts, and auditing releases."}
				...
				<MeasurableResults 
					description="Standardizing 14 delivery pipelines in Azure DevOps cut release manual steps by 52%, accelerated cycles, and centralized auditability."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The Azure work gave us a foundation we could actually operate. Azure DevOps stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta 
					title={"Ready to improve your Azure foundation with Azure DevOps?"}
					description={"OpenGridLabs designs and builds Azure cloud systems for azure devops, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
