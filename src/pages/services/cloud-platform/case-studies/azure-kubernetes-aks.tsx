...
const STATS = [
	{ value: "18", label: "Services onboarded to AKS platform", accent: "from-emerald-500 to-teal-600" },
	{ value: "32%", label: "Reduction in deployment friction across services", accent: "from-purple-500 to-indigo-600" },
	{ value: "45%", label: "Faster environment provisioning", accent: "from-blue-500 to-cyan-600" },
	{ value: "12 wk", label: "From container pilots to AKS production platform", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Services onboarded", before: "Container pilots", after: "18 services", change: "Onboarded" },
	{ metric: "Deployment friction", before: "Baseline", after: "68% of baseline", change: "-32%" },
	{ metric: "Environment provisioning", before: "Baseline", after: "1.45x faster", change: "Faster" },
	{ metric: "Cluster access", before: "Manual roles", after: "Managed identity controls", change: "Secured" },
...
const FAQS = [
	{
		...
		a: "Azure Kubernetes Service (AKS) is an Azure capability used to support production workloads through cloud compute, storage, networking, identity, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Azure Kubernetes Service (AKS)?",
		a: "Companies invest in Azure Kubernetes Service (AKS) to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Microsoft Azure. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function AzureKubernetesAKSCaseStudy() {
	return (
		<>
			<SEO
				title="Azure Kubernetes Service (AKS) Case Study | OpenGridLabs"
				description="How OpenGridLabs built a production Azure Kubernetes Service (AKS) platform for 18 cloud-native SaaS services, reducing deployment friction by 32%."
				canonical="/services/cloud-platform/azure-kubernetes-aks"
				keywords="Azure Kubernetes, AKS, Azure Kubernetes Service, Kubernetes on Azure, Container Orchestration, Azure Containers, Cloud Native, Kubernetes Deployment, Microsoft Azure, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Azure Kubernetes Service (AKS) Created a Production Kubernetes Platform on Azure"
					description="A product engineering team wanted Kubernetes flexibility without unmanaged cluster risk. OpenGridLabs built an AKS platform with node pools, ingress, managed identity, deployment pipelines, observability, and workload standards for production services."
					...
					details={[
						...
						{ label: "Scope", value: "18 services onboarded" },
						{ label: "Timeline", value: "12 weeks to production" },
						{ label: "Stack", value: "AKS · Kubernetes · Ingress · Managed Identity" }
					]}
				/>

				<CaseStudyCarousel
									slug="azure-kubernetes-aks"
									title="Azure Kubernetes Service (AKS)"
									accentColor="blue"
									aspectRatioClass="aspect-[3/2]"
									images={[
										"/images/case-studies/azure-kubernetes-aks/1.jpg",
										"/images/case-studies/azure-kubernetes-aks/2.jpg"
									]}
								/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Azure Kubernetes Service (AKS) that could move beyond a tactical cloud setup and become part of a reliable Azure operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.",
						"Azure Kubernetes Service (AKS) is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Azure Kubernetes Service (AKS)?"
					definitionText="Azure Kubernetes Service (AKS) is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"AKS Architecture Layers"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"A twelve-week progressive roadmap moving container pilots to a highly reliable production AKS platform."}
				...
				<MeasurableResults 
					description="Standardizing workloads on AKS reduced deployment friction, sped up environment provisioning times, and enforced secure cluster access."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The Azure work gave us a foundation we could actually operate. Azure Kubernetes Service (AKS) stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta 
					title={"Ready to improve your Azure foundation with Azure Kubernetes Service (AKS)?"}
					description={"OpenGridLabs designs and builds Azure cloud systems for azure kubernetes (aks), combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
