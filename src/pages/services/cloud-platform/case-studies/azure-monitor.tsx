...
const STATS = [
	{ value: "72", label: "Azure Monitor alerts created or tuned", accent: "from-emerald-500 to-teal-600" },
	{ value: "51%", label: "Reduction in noisy or unactionable alerts", accent: "from-purple-500 to-indigo-600" },
	{ value: "38%", label: "Faster incident triage on covered services", accent: "from-blue-500 to-cyan-600" },
...
const TABLE_RESULTS = [
	{ metric: "Azure Monitor alerts", before: "Ad hoc alerts", after: "72 tuned alerts", change: "Actionable" },
	{ metric: "Alert noise", before: "Baseline", after: "49% of baseline", change: "-51%" },
	{ metric: "Incident triage", before: "Baseline", after: "1.38x faster", change: "Faster" },
...
const FAQS = [
	{
		...
		a: "Azure Monitor is an Azure capability used to support production workloads through cloud compute, storage, networking, identity, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Azure Monitor?",
		a: "Companies invest in Azure Monitor to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Microsoft Azure. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function AzureMonitorCaseStudy() {
	return (
		<>
			<SEO
				title="Azure Monitor Observability Case Study | OpenGridLabs"
				description="How OpenGridLabs implemented Azure Monitor alerts, dashboards, and runbooks for client workloads, reducing alert noise by 51% and accelerating triage."
				canonical="/services/cloud-platform/azure-monitor"
				keywords="Azure Monitor, Log Analytics, Application Insights, Azure Alerts, Cloud Monitoring, Azure Observability, Incident Response, Monitoring Dashboards, Microsoft Azure, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Azure Monitor Turned Cloud Signals Into Actionable Operations"
					description="A production Azure environment generated logs and metrics, but teams lacked reliable dashboards, alert rules, and incident context. OpenGridLabs implemented Azure Monitor with metrics, logs, alerts, dashboards, application insights, and runbook-linked operations."
					...
					details={[
						...
						{ label: "Scope", value: "72 alerts tuned" },
						{ label: "Timeline", value: "7 weeks to production" },
						{ label: "Stack", value: "Azure Monitor · Log Analytics · Alerts · Application Insights" }
					]}
				/>
				...
				<CaseStudyCarousel
									...
									images={[
										"/images/case-studies/azure-monitor/1.jpg",
										"/images/case-studies/azure-monitor/2.jpg"
									]}
								/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Azure Monitor that could move beyond a tactical cloud setup and become part of a reliable Azure operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.",
						"Azure Monitor is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Azure Monitor?"
					definitionText="Azure Monitor is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<CaseStudyArchitecture 
					...
					tag={"Blueprint"}
					title={"Azure Monitor Architecture"}
					...
					rightColumnTitle={"Azure Monitor Architecture Layers"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"A seven-week optimization plan tuning monitoring filters, alert rules, runbooks, and telemetry signals."}
				...
				<MeasurableResults 
					description="Decoupling monitoring signals and tuning alerts decreased alert fatigue, minimized incident triage times, and linked runs to actionable guidelines."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The Azure work gave us a foundation we could actually operate. Azure Monitor stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta 
					title={"Ready to improve your Azure foundation with Azure Monitor?"}
					description={"OpenGridLabs designs and builds Azure cloud systems for azure monitor, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
