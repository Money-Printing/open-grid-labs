		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero
					...
					categoryBorderClass="border-red-500/30"
					categoryBgClass="bg-red-500/10"
					categoryTextClass="text-red-400"
					glowBgClass="bg-red-400"
					terminalIconClass="text-red-400"
					detailsTitle="Project Scope"
					details={[
						{ label: "Sector", value: "Public SaaS and ecommerce platform (anonymised)" },
						{ label: "Scope", value: "27 security policies configured" },
						{ label: "Timeline", value: "6 weeks to production" },
						{ label: "Stack", value: "Cloud Armor · WAF · Rate Limiting · Edge Security" }
					]}
				/>
				...
				<CaseStudyBackground
					...
					contextHighlightColorClass="bg-red-400"
					contextIconColorClass="text-red-400"
					definitionTitle="What Is Cloud Armor?"
					definitionText="Cloud Armor is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					definitionIcon={<ShieldAlert className="w-6 h-6 animate-pulse" />}
					definitionIconBgClass="bg-red-500/10"
					definitionIconBorderClass="border-red-500/20"
					definitionIconColorClass="text-red-400"
					glowColorClass="bg-red-400"
				...
				<ChallengesSolutions
					...
					description={"How OpenGridLabs designed security boundaries, repeatability, and observability for Cloud Armor."}
				...
				<CaseStudyArchitecture
					...
					tagColorClass={"text-red-400"}
					highlightColorClass={"bg-red-400"}
					gradientColorClass={"via-red-400/50"}
					alertBorderClass={"border-red-500/20"}
					alertBgClass={"bg-red-500/5"}
					alertTextColorClass={"text-red-300"}
				...
				<CaseStudyCta
					...
					glowBgClass={"bg-red-400"}
					iconColorClass={"text-red-400"}
					btnGradientClass={"from-red-400 to-indigo-500"}
					btnShadowColor={"239,68,68,0.2"}
				/>
			</div>
		</>
	);
