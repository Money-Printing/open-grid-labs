		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero
					...
					title="How Cloud SQL Stabilized Managed Databases for Production Growth"
					description="A data-heavy application used relational databases without consistent backup, replica, performance, and migration practices. OpenGridLabs redesigned Cloud SQL usage with parameter tuning, backups, replicas, monitoring, maintenance windows, and migration runbooks."
					...
					details={[
						...
						{ label: "Scope", value: "5 Cloud SQL instances optimized" },
						{ label: "Timeline", value: "10 weeks to production" },
						{ label: "Stack", value: "Cloud SQL · Read Replicas · Backups · Query Insights" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/cloud-sql/1.jpg",
						"/images/case-studies/cloud-sql/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground
					...
					definitionTitle="What Is Cloud SQL?"
					definitionText="Cloud SQL is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<ChallengesSolutions
					...
					description={"How OpenGridLabs designed security boundaries, repeatability, and observability for Cloud SQL."}
				...
				<CaseStudyArchitecture
					...
					rightColumnTitle={"Cloud SQL Architecture Layers"}
				/>
				...
				<CaseStudyQuote
					quote={"The GCP work gave us a foundation we could actually operate. Cloud SQL stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta
					title={"Ready to improve your GCP foundation with Cloud SQL?"}
					description={"OpenGridLabs designs and builds Google Cloud systems for cloud sql, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
