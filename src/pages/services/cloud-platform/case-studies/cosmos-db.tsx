...
const STATS = [
	{ value: "9", label: "Cosmos DB containers redesigned and governed", accent: "from-emerald-500 to-teal-600" },
	{ value: "47%", label: "Reduction in hot partition incidents", accent: "from-purple-500 to-indigo-600" },
	{ value: "38%", label: "Improvement in read latency on priority queries", accent: "from-blue-500 to-cyan-600" },
	{ value: "10 wk", label: "From document store sprawl to Cosmos DB model", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Cosmos containers", before: "Ad hoc collections", after: "9 governed containers", change: "Redesigned" },
	{ metric: "Hot partition incidents", before: "Baseline", after: "53% of baseline", change: "-47%" },
	{ metric: "Read latency", before: "Baseline", after: "1.38x faster", change: "Faster" },
	{ metric: "Indexing strategy", before: "Default indexes", after: "Query-driven indexing", change: "Optimized" },
	{ metric: "Throughput control", before: "Manual scaling", after: "RU governance", change: "Cost-aware" }
];
...
const FAQS = [
	{
		q: "What is Cosmos DB?",
		a: "Cosmos DB is an Azure capability used to support production workloads through cloud compute, storage, networking, identity, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Cosmos DB?",
		a: "Companies invest in Cosmos DB to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Microsoft Azure. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function CosmosDBCaseStudy() {
	return (
		<>
			<SEO
				title="Azure Cosmos DB Case Study | OpenGridLabs"
				description="How OpenGridLabs redesigned and optimized 9 Cosmos DB containers, reducing hot partition incidents by 47% and query latencies by 38%."
				canonical="/services/cloud-platform/cosmos-db"
				keywords="Cosmos DB, Azure Cosmos DB, NoSQL Database, Partition Keys, Global Database, RU Optimization, Azure Database, Low Latency Data, Microsoft Azure, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Cosmos DB Scaled Low-Latency Data Access for Global Product Workflows"
					description="A data-heavy application needed fast reads, flexible data models, and global availability without complex database operations. OpenGridLabs designed Cosmos DB containers, partition keys, indexing, throughput controls, backups, and monitoring."
					...
					details={[
						{ label: "Sector", value: "Global SaaS and customer data platform (anonymised)" },
						{ label: "Scope", value: "9 containers redesigned" },
						{ label: "Timeline", value: "10 weeks to production" },
						{ label: "Stack", value: "Cosmos DB · Partition Keys · RU/s · Global Replication" }
					]}
				/>
				...
				<CaseStudyCarousel
									...
									images={[
										"/images/case-studies/cosmos-db/1.jpg",
										"/images/case-studies/cosmos-db/2.jpg"
									]}
								/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Cosmos DB that could move beyond a tactical cloud setup and become part of a reliable Azure operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.",
						"Cosmos DB is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Cosmos DB?"
					definitionText="Cosmos DB is an Azure capability used to run, store, secure, scale, connect, observe, or modernize production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Cosmos DB Architecture Layers"}
				/>
				...
				<CaseStudyTimeline 
					...
					description={"A ten-week progressive roadmap shifting database models, partitioning keys, and query indexes."}
				...
				<MeasurableResults 
					description="Optimizing Cosmos DB partition layout and query indexes significantly decreased hot partition bottlenecks, boosted query execution speeds, and governed RU/s costs."
					results={TABLE_RESULTS}
				/>

				<CaseStudyQuote 
					quote={"The Azure work gave us a foundation we could actually operate. Cosmos DB stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta 
					title={"Ready to improve your Azure foundation with Cosmos DB?"}
					description={"OpenGridLabs designs and builds Azure cloud systems for cosmos db, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
