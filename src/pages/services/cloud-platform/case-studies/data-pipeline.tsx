		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero
					...
					title="How Data Pipeline Automated Trusted Data Movement Across Cloud Systems"
					description="A data team moved product, customer, billing, and event data with manual scripts and fragile schedules. OpenGridLabs built a GCP data pipeline with ingestion, validation, transformation, orchestration, monitoring, and curated datasets for analytics and operations."
					...
					details={[
						{ label: "Sector", value: "Data platform and analytics organization (anonymised)" },
						{ label: "Scope", value: "19 data workflows automated" },
						{ label: "Timeline", value: "11 weeks to production" },
						{ label: "Stack", value: "Dataflow · BigQuery · Cloud Composer · Pub/Sub" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/data-pipeline/1.jpg",
						"/images/case-studies/data-pipeline/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground
					...
					definitionTitle="What Is Data Pipeline?"
					definitionText="Data Pipeline is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<ChallengesSolutions
					...
					description={"How OpenGridLabs designed security boundaries, repeatability, and observability for Data Pipeline workflows."}
				...
				<CaseStudyArchitecture
					...
					rightColumnTitle={"Data Pipeline Architecture Layers"}
				/>
				...
				<CaseStudyQuote
					quote={"The GCP work gave us a foundation we could actually operate. Data Pipeline stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta
					title={"Ready to improve your GCP foundation with Data Pipeline?"}
					description={"OpenGridLabs designs and builds Google Cloud systems for data pipeline, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
