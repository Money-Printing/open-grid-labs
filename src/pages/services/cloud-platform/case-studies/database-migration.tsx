...
const STATS = [
	{ value: "3", label: "Production databases migrated to AWS", accent: "from-teal-500 to-emerald-600" },
	{ value: "99.9%", label: "Data validation match rate during cutover checks", accent: "from-blue-500 to-cyan-600" },
	{ value: "42%", label: "Improvement in query performance after tuning", accent: "from-indigo-500 to-purple-600" },
	{ value: "12 wk", label: "From legacy database to AWS migration", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Databases migrated", before: "Legacy hosting", after: "3 AWS databases", change: "Migrated" },
	{ metric: "Data validation", before: "Manual spot checks", after: "99.9% match rate", change: "Verified" },
	{ metric: "Query performance", before: "Baseline", after: "1.42x faster", change: "Improved" },
	{ metric: "Cutover risk", before: "Unrehearsed", after: "Rehearsed runbook", change: "Safer" },
	{ metric: "Rollback readiness", before: "Unclear", after: "Tested rollback plan", change: "Controlled" }
];
...
const FAQS = [
	{
		...
		a: "Database Migration is an AWS capability used to support production workloads through cloud compute, storage, networking, security, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Database Migration?",
		a: "Companies invest in Database Migration to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on AWS. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function DatabaseMigrationCaseStudy() {
	...
	return (
		<>
			<SEO
				title="AWS Database Migration Case Study | OpenGridLabs"
				description="How OpenGridLabs executed a seamless AWS database migration with a 99.9% data validation match rate and a 42% query performance speedup."
				canonical="/services/cloud-platform/database-migration"
				keywords="Database Migration, AWS DMS, AWS Database Migration, RDS Migration, Cloud Database Migration, Data Validation, Database Cutover, Legacy Modernization, OpenGridLabs"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<div 
					...
					style={{
						background: `radial-gradient(circle, hsl(160,100%,40%) 0%, hsl(200,100%,50%) 50%, transparent 100%)`
					}}
				/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							<div className="flex items-center gap-3">
								<span className="text-xs md:text-sm font-bold tracking-widest uppercase px-4 py-1.5 rounded-full border border-teal-500/30 bg-teal-500/10 text-teal-400 backdrop-blur-md">
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Database Migration Moved Critical Data to AWS With Minimal Disruption
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A product team needed to migrate legacy databases to AWS without extended downtime or data integrity risk. OpenGridLabs planned and executed database migration with schema review, replication, validation, cutover rehearsal, rollback planning, and post-migration tuning.
							</p>
						</motion.div>
						...
						>
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								<div className="absolute -top-12 -right-12 w-32 h-32 blur-3xl opacity-20 pointer-events-none rounded-full bg-teal-400" />
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Data-heavy SaaS and operations platform (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">3 databases migrated</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">DMS · RDS · Replication · Cutover</span>
									</div>
								</div>
							</div>
						</motion.div>
					...
					<div className="grid md:grid-cols-4 gap-6">
						{STATS.map((stat, idx) => (
							<motion.div
								...
								className="glass-panel p-8 rounded-3xl border border-black/5 dark:border-white/5 hover:border-teal-500/30 transition-all duration-300 shadow-xl relative overflow-hidden group"
							>
								...
								<div className="space-y-2 relative z-10">
									<p className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-foreground via-foreground to-muted-foreground group-hover:text-teal-400 transition-colors">
										{stat.value}
									</p>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							<div className="flex items-center gap-2">
								...
								<span className="text-xs md:text-sm font-bold uppercase tracking-widest text-teal-400">Context</span>
							</div>
							<h2 className="text-3xl md:text-5xl font-bold uppercase tracking-tight text-foreground leading-tight">
								Background
							</h2>
							<div className="w-16 h-1 rounded-full bg-teal-400" />
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Database Migration that could move beyond a tactical cloud setup and become part of a reliable AWS operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.
							</p>
						</div>

						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-teal-950/10 via-background to-background shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							<div className="absolute -top-12 -right-12 w-40 h-40 blur-3xl opacity-15 pointer-events-none rounded-full bg-teal-400 animate-pulse" />
							...
							<div className="space-y-6 relative z-10">
								...
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Database Migration is an AWS cloud capability used to run, store, secure, scale, connect, observe, or migrate production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership.
								</p>
							</div>
						</div>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs designed security boundaries, repeatability, and observability for Database Migration.
						</p>
					</div>
					...
					<div className="space-y-6">
						{CHALLENGES.map((challenge, idx) => (
							<motion.div 
								...
								className="glass-panel p-8 rounded-[28px] border border-black/5 dark:border-white/5 hover:border-teal-500/20 transition-all duration-300 shadow-lg relative overflow-hidden"
							>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							<div className="lg:col-span-5 space-y-6">
								<div className="flex items-center gap-2">
									...
									<span className="text-xs md:text-sm font-bold uppercase tracking-widest text-teal-400">Blueprint</span>
								</div>
								<h2 className="text-3xl md:text-5xl font-bold uppercase tracking-tight text-foreground leading-tight">
									System Architecture
								</h2>
								...
								{/* Shield Check Alert */}
								<div className="flex items-start gap-4 p-5 rounded-2xl border border-teal-500/20 bg-teal-500/5 text-teal-300">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Database Migration Architecture Layers
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					...
					<div className="relative border-l border-white/10 md:border-l-0 md:flex md:flex-row gap-8 space-y-12 md:space-y-0 md:justify-between items-stretch">
						...
						<div className="hidden md:block absolute left-0 right-0 top-10 h-[2px] bg-gradient-to-r from-teal-500 via-blue-500 to-purple-500 opacity-20" />
						...
						{PHASES.map((phase, idx) => (
							...
							>
								<div 
									...
									style={{ backgroundImage: `linear-gradient(to right, ${idx === 0 ? "hsl(160,100%,40%)" : idx === 1 ? "hsl(200,100%,50%)" : "hsl(280,100%,60%)"}, transparent)` }}
								/>
								<div className="space-y-6">
									<div className="flex items-center justify-between">
										<span className="text-xs font-bold uppercase tracking-widest text-teal-400 bg-teal-400/10 px-3.5 py-1 rounded-full border border-teal-400/20">
											{phase.number}
										</span>
									</div>
							...
							<table className="w-full text-left border-collapse">
								<thead>
									<tr className="bg-white/5 border-b border-white/10">
										...
										<th className="p-6 text-sm font-bold uppercase tracking-wider text-teal-400">After</th>
								...
								<tbody>
									{TABLE_RESULTS.map((row, idx) => (
										<tr key={idx} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
											...
											<td className="p-6 text-teal-400 font-bold text-base">{row.after}</td>
				...
				<section className="w-[90%] max-w-[1200px] mx-auto mt-32 relative z-10 text-center">
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						<div className="absolute top-8 left-10 text-teal-500/10 opacity-20 pointer-events-none">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The AWS work gave us a foundation we could actually operate. Database Migration stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."
							</p>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					...
					<div className="grid md:grid-cols-2 gap-8">
						{SUCCESS_FACTORS.map((factor, idx) => (
							<div 
								key={idx}
								className="glass-panel p-8 md:p-12 rounded-[32px] border border-black/5 dark:border-white/5 hover:border-teal-500/20 transition-all duration-300 shadow-xl space-y-4"
							>
								<div className="flex items-center gap-3">
							...
							return (
								...
								>
									...
									>
										...
										<ChevronDown className={`w-5 h-5 text-muted-foreground transition-transform duration-300 ${isOpen ? 'rotate-180 text-teal-400' : ''}`} />
									</button>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						<div 
							className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 blur-[120px] opacity-15 rounded-full pointer-events-none bg-teal-400"
						/>
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							<Sparkles className="w-10 h-10 mx-auto text-teal-400 animate-pulse" />
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to improve your AWS foundation with Database Migration?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs and builds AWS cloud systems for database migration, combining architecture, automation, security, monitoring, cost governance, and production rollout support.
							</p>
							<div className="flex flex-col sm:flex-row justify-center items-center gap-4">
								<Link 
									to="/contact-us"
									className="px-8 py-4 rounded-full font-bold uppercase tracking-wider text-sm transition-all duration-300 shadow-lg text-white bg-gradient-to-r from-teal-400 to-blue-500 hover:shadow-teal-400/20"
									style={{ 
