		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero
					...
					title="How Google Kubernetes Engine (GKE) Created a Production Kubernetes Platform on Google Cloud"
					description="A product engineering team wanted Kubernetes flexibility without unmanaged cluster risk. OpenGridLabs built a GKE platform with node pools, ingress, workload identity, deployment pipelines, observability, and workload standards for production services."
					...
					details={[
						...
						{ label: "Scope", value: "16 services onboarded" },
						{ label: "Timeline", value: "12 weeks to production" },
						{ label: "Stack", value: "GKE · Kubernetes · Ingress · Workload Identity" }
					]}
				/>

				<CaseStudyCarousel
					slug="google-kubernetes-gke"
					title="Google Kubernetes Engine (GKE)"
					accentColor="blue"
					aspectRatioClass="aspect-[3/2]"
					images={[
						"/images/case-studies/google-kubernetes-gke/1.jpg",
						"/images/case-studies/google-kubernetes-gke/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground
					...
					definitionTitle="What Is GKE?"
					definitionText="Google Kubernetes Engine (GKE) is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<ChallengesSolutions
					...
					description={"How OpenGridLabs designed security boundaries, repeatability, and observability for Google Kubernetes Engine (GKE)."}
				...
				<CaseStudyArchitecture
					...
					rightColumnTitle={"GKE Architecture Layers"}
				/>
				...
				<CaseStudyQuote
					quote={"The GCP work gave us a foundation we could actually operate. Google Kubernetes Engine (GKE) stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta
					title={"Ready to improve your GCP foundation with Google Kubernetes Engine (GKE)?"}
					description={"OpenGridLabs designs and builds Google Cloud systems for google kubernetes (gke), combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
