		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero
					...
					title="How Multi-cloud Integration Connected GCP With Existing Cloud and Enterprise Systems"
					description="A company used GCP alongside AWS, SaaS tools, and legacy enterprise systems, but data movement and identity patterns were inconsistent. OpenGridLabs designed multi-cloud integration with secure connectivity, event flows, API gateways, data sync, monitoring, and operational runbooks."
					...
					details={[
						{ label: "Sector", value: "Enterprise platform with multi-cloud footprint (anonymised)" },
						{ label: "Scope", value: "8 systems connected" },
						{ label: "Timeline", value: "12 weeks to production" },
						{ label: "Stack", value: "GCP · APIs · VPN · Pub/Sub" }
					]}
				/>

				<CaseStudyCarousel
					slug="multi-cloud-integration"
					title="Multi-cloud Integration"
					accentColor="blue"
					aspectRatioClass="aspect-[3/2]"
					images={[
						"/images/case-studies/multi-cloud-integration/1.jpg",
						"/images/case-studies/multi-cloud-integration/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground
					...
					definitionTitle="What Is Multi-cloud Integration?"
					definitionText="Multi-cloud Integration is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<ChallengesSolutions
					...
					description={"How OpenGridLabs designed security boundaries, repeatability, and observability for Multi-cloud Integration systems."}
				...
				<CaseStudyArchitecture
					...
					rightColumnTitle={"Multi-cloud Integration Architecture Layers"}
				/>
				...
				<CaseStudyQuote
					quote={"The GCP work gave us a foundation we could actually operate. Multi-cloud Integration stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta
					title={"Ready to improve your GCP foundation with Multi-cloud Integration?"}
					description={"OpenGridLabs designs and builds Google Cloud systems for multi-cloud integration, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
