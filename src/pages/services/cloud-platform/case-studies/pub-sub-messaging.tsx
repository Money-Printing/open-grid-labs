...
const STATS = [
	{ value: "21", label: "Pub/Sub event streams launched", accent: "from-blue-500 to-cyan-600" },
	{ value: "−57%", label: "Reduction in direct service coupling for key workflows", accent: "from-purple-500 to-indigo-600" },
	{ value: "88%", label: "Automatic recovery from transient consumer failures", accent: "from-emerald-500 to-teal-600" },
	{ value: "8 wk", label: "From point-to-point calls to event messaging", accent: "from-amber-500 to-orange-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Event streams", before: "Direct service calls", after: "21 Pub/Sub streams", change: "Decoupled" },
	{ metric: "Service coupling", before: "Baseline", after: "43% of baseline", change: "−57%" },
	{ metric: "Transient recovery", before: "Manual replays", after: "88% automatic recovery", change: "Reliable" },
	{ metric: "Dead-letter handling", before: "Ad hoc", after: "DLQ process", change: "Controlled" },
	{ metric: "Event visibility", before: "Limited logs", after: "Topic dashboards", change: "Operational" }
];
...
const FAQS = [
	{
		...
		a: "Pub/Sub Messaging is a GCP capability used to support production workloads through cloud compute, storage, networking, security, analytics, observability, scaling, or managed services. It is most effective when designed with automation, monitoring, cost controls, and security from the start."
	},
	{
		q: "Why do companies invest in Pub/Sub Messaging?",
		a: "Companies invest in Pub/Sub Messaging to improve reliability, scalability, security, delivery speed, operational visibility, and cost efficiency on Google Cloud. The strongest results come when architecture, implementation, automation, monitoring, and ownership are planned together."
	}
];

export default function PubSubMessagingCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Google Cloud Pub/Sub Decoupled Event Workflows Case Study | OpenGridLabs"
				description="How OpenGridLabs implemented Pub/Sub messaging, launching 21 event streams and reducing direct service coupling by 57%."
				canonical="/services/cloud-platform/pub-sub-messaging"
				keywords="Pub/Sub Messaging, Google Pub/Sub, GCP Messaging, Event Driven Architecture, Message Queues, OpenGridLabs"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Pub/Sub Messaging Decoupled Event Workflows With Reliable Messaging
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A platform had services calling each other directly, creating fragile dependencies and slow user-facing workflows. OpenGridLabs implemented Pub/Sub messaging with topics, subscriptions, retry policies, dead-letter handling, monitoring, and event schema standards.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">21 event streams launched</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Pub/Sub · Event Streams · Dead Letters · Cloud Monitoring</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Pub/Sub Messaging that could move beyond a tactical cloud setup and become part of a reliable GCP operating model. OpenGridLabs designed the architecture, security controls, automation, monitoring, cost governance, and rollout plan needed to support production workloads with confidence.
							</p>
						</div>
						...
						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-blue-950/10 via-background to-background shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							...
							<div className="space-y-6 relative z-10">
								...
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Pub/Sub Messaging is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership.
								</p>
							</div>
						</div>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs designed security boundaries, repeatability, and observability for Pub/Sub Messaging workloads.
						</p>
					</div>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The GCP work gave us a foundation we could actually operate. Pub/Sub Messaging stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to improve your GCP foundation with Pub/Sub Messaging?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs and builds Google Cloud systems for pub/sub messaging, combining architecture, automation, security, monitoring, cost governance, and production rollout support.
							</p>
