		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero
					...
					title="How Pub/Sub Messaging Decoupled Event Workflows With Reliable Messaging"
					description="A platform had services calling each other directly, creating fragile dependencies and slow user-facing workflows. OpenGridLabs implemented Pub/Sub messaging with topics, subscriptions, retry policies, dead-letter handling, monitoring, and event schema standards."
					...
					details={[
						{ label: "Sector", value: "Event-driven SaaS and operations platform (anonymised)" },
						{ label: "Scope", value: "21 event streams launched" },
						{ label: "Timeline", value: "8 weeks to production" },
						{ label: "Stack", value: "Pub/Sub · Event Streams · Dead Letters · Cloud Monitoring" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/pub-sub-messaging/1.jpg",
						"/images/case-studies/pub-sub-messaging/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground
					...
					definitionTitle="What Is Pub/Sub Messaging?"
					definitionText="Pub/Sub Messaging is a Google Cloud capability used to run, store, secure, scale, connect, observe, or analyze production workloads. In practice, it requires architecture decisions, access controls, automation, monitoring, cost governance, and operational ownership."
				...
				<ChallengesSolutions
					...
					description={"How OpenGridLabs designed security boundaries, repeatability, and observability for Pub/Sub Messaging workloads."}
				...
				<CaseStudyArchitecture
					...
					rightColumnTitle={"Pub/Sub Architecture Layers"}
				/>
				...
				<CaseStudyQuote
					quote={"The GCP work gave us a foundation we could actually operate. Pub/Sub Messaging stopped being a set of manual cloud tasks and became a reliable capability with visibility, ownership, and safer scaling."}
				...
				<CaseStudyCta
					title={"Ready to improve your GCP foundation with Pub/Sub Messaging?"}
					description={"OpenGridLabs designs and builds Google Cloud systems for pub/sub messaging, combining architecture, automation, security, monitoring, cost governance, and production rollout support."}
