...
export default function ServicesLegacyModernization() {
	return (
		<div className="bg-background min-h-screen font-sans overflow-x-hidden">
			<SEO
				title="Legacy Modernization - Web, Mobile & Backend | OpenGridLabs"
				...
				canonical="/services/legacy-modernization"
