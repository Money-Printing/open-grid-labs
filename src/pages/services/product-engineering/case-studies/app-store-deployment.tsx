		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How App Store Deployment Turned Release Submission Into a Predictable Launch Workflow"
					description="A mobile team had strong features ready, but app store submission was slow, stressful, and error-prone. OpenGridLabs created an App Store Deployment workflow covering metadata, screenshots, compliance, build signing, release tracks, review preparation, and rollback planning."
					...
					details={[
						{ label: "Sector", value: "Mobile product and growth team (anonymised)" },
						{ label: "Scope", value: "2 stores prepared" },
						{ label: "Timeline", value: "5 weeks to launch" },
						{ label: "Stack", value: "App Store · Play Store · Signing · Release Tracks" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/app-store-deployment/1.jpg",
						"/images/case-studies/app-store-deployment/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is App Store Deployment?"
					definitionText="App Store Deployment is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs resolved app store metadata, signing, and submission bottlenecks."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"App Store Deployment Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made app store deployment feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."}
				...
				<CaseStudyCta 
					title={"Ready to improve your mobile application with App Store Deployment?"}
					description={"OpenGridLabs designs and builds mobile application systems for app store deployment, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support."}
