		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How App UI/UX Increased Mobile Engagement With a Cleaner App Experience"
					description="A mobile product had useful features, but users struggled with onboarding, navigation, forms, and task completion. OpenGridLabs redesigned the app UI/UX around mobile-first journeys, clearer hierarchy, touch-friendly controls, and measurable interaction analytics."
					...
					details={[
						{ label: "Sector", value: "Consumer app and SaaS mobile portal (anonymised)" },
						{ label: "Scope", value: "16 app flows redesigned" },
						{ label: "Timeline", value: "8 weeks to launch" },
						{ label: "Stack", value: "Mobile UX · Design System · Prototypes · Usability Testing" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/app-ui-ux/1.jpg",
						"/images/case-studies/app-ui-ux/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is App UI/UX Design?"
					definitionText="App UI/UX is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs redesigned mobile UI/UX and resolved user friction checkpoints."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"App UI/UX Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made app ui/ux feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."}
				...
				<CaseStudyCta 
					title={"Ready to improve your mobile app experience?"}
					description={"OpenGridLabs designs and builds mobile application systems for app ui/ux, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support."}
