...
const STATS = [
	{ value: "5", label: "Camera capture workflows launched", accent: "from-purple-400 to-indigo-500" },
	{ value: "48%", label: "Reduction in failed or incomplete uploads", accent: "from-pink-400 to-purple-500" },
	{ value: "33%", label: "Faster document and photo submission", accent: "from-fuchsia-500 to-pink-500" },
	{ value: "9 wk", label: "From external capture to in-app camera workflow", accent: "from-violet-400 to-purple-600" }
];
...
const TABLE_RESULTS = [
	{ metric: "Capture workflows", before: "External camera use", after: "5 workflows", change: "Integrated" },
	{ metric: "Failed uploads", before: "Baseline", after: "52% of baseline", change: "-48%" },
	{ metric: "Submission speed", before: "Baseline", after: "1.33x faster", change: "Faster" },
	{ metric: "Image metadata", before: "Manual context", after: "Auto-attached metadata", change: "Improved" },
	{ metric: "Review process", before: "Email follow-up", after: "In-app review queue", change: "Controlled" }
];
...
const FAQS = [
	{
		q: "What is Camera Integration?",
		a: "Camera Integration is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics."
	},
	{
		q: "Why do companies invest in Camera Integration?",
		a: "Companies invest in Camera Integration to improve mobile usability, reliability, engagement, release speed, platform coverage, and operational visibility. The strongest results come when product, design, mobile engineering, backend services, QA, and analytics are planned together."
	}
];

export default function CameraIntegrationCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Camera Integration Case Study | OpenGridLabs"
				description="How OpenGridLabs built native mobile camera integration with guided capture, compression, metadata, and upload retry logic."
				canonical="/services/product-engineering/camera-integration"
				keywords="Camera Integration, Mobile Camera API, Image Upload, Document Capture, Photo Capture App, Mobile Scanning, Media Upload, Field App Camera"
			/>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Camera Integration Streamlined Capture, Review, and Upload Inside the App
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A mobile workflow depended on photos and scans, but users jumped between the camera, gallery, and manual upload steps. OpenGridLabs built camera integration with guided capture, compression, metadata, upload retry, and review queues.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Insurance, field operations, and document capture (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">5 capture workflows launched</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Camera API · Image Upload · Compression · Review Queue</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-24 relative z-10">
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Camera Integration that could move beyond a prototype and support real users across devices, connectivity conditions, app store requirements, and operational workflows. OpenGridLabs designed the mobile architecture, UX patterns, integrations, QA process, and launch plan needed to make the capability reliable in production.
							</p>
						</div>
						...
						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-purple-950/20 via-background to-background shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							...
							<div className="space-y-6 relative z-10">
								...
								<p className="text-base md:text-lg text-muted-foreground leading-relaxed">
									Camera Integration is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics.
								</p>
							</div>
						</div>
					</div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs integrated camera workflows, background compression, and upload recovery mechanics.
						</p>
					</div>
						...
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Camera Integration Architecture Stages
								</h3>
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The work made camera integration feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to improve your mobile application with Camera Integration?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs and builds mobile application systems for camera integration, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support.
							</p>
