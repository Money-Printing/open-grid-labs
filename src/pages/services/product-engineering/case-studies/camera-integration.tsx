		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Camera Integration Streamlined Capture, Review, and Upload Inside the App"
					description="A mobile workflow depended on photos and scans, but users jumped between the camera, gallery, and manual upload steps. OpenGridLabs built camera integration with guided capture, compression, metadata, upload retry, and review queues."
					...
					details={[
						{ label: "Sector", value: "Insurance, field operations, and document capture (anonymised)" },
						{ label: "Scope", value: "5 capture workflows launched" },
						{ label: "Timeline", value: "9 weeks to production" },
						{ label: "Stack", value: "Camera API · Image Upload · Compression · Review Queue" }
					]}
				/>

				<CaseStudyCarousel
					slug="camera-integration"
					title="Camera Integration"
					accentColor="purple"
					aspectRatioClass="aspect-[3/2]"
					images={[
						"/images/case-studies/camera-integration/1.jpg",
						"/images/case-studies/camera-integration/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Camera Integration?"
					definitionText="Camera Integration is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs integrated camera workflows, background compression, and upload recovery mechanics."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Camera Integration Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made camera integration feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."}
				...
				<CaseStudyCta 
					title={"Ready to improve your mobile application with Camera Integration?"}
					description={"OpenGridLabs designs and builds mobile application systems for camera integration, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support."}
