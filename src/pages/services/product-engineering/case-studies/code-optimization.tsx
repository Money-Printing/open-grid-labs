		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Code Optimization Improved Performance and Maintainability Across a Complex Frontend"
					description="A web application had grown slower and harder to change as features accumulated. OpenGridLabs optimized code splitting, rendering paths, bundle size, API usage, and component structure to improve performance while reducing maintenance burden."
					...
					details={[
						{ label: "Sector", value: "High-traffic SaaS dashboard (anonymised)" },
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs built a modern architecture to optimize frontend delivery and maintainability."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Code Optimization Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made code optimization feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with Code Optimization?"}
					description={"OpenGridLabs designs and builds web application systems for code optimization, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
