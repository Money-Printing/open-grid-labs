		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Cross-Platform Apps Reduced Delivery Cost While Supporting iOS and Android"
					description="A company needed mobile coverage across iOS and Android without running two separate product teams. OpenGridLabs designed a cross-platform app architecture with shared UI, shared business logic, platform-specific integrations, and coordinated releases."
					...
					details={[
						{ label: "Sector", value: "B2B SaaS and field operations app (anonymised)" },
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Are Cross-Platform Apps?"
					definitionText="Cross-Platform Apps is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs unified iOS and Android development under a single cross-platform codebase."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Cross-Platform Apps Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made cross-platform apps feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."}
				...
				<CaseStudyCta 
					title={"Ready to build production-ready cross-platform apps?"}
					description={"OpenGridLabs designs and builds mobile application systems for cross-platform apps, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support."}
