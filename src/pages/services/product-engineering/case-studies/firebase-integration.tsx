		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Firebase Integration Accelerated Mobile Delivery With Managed App Services"
					description="A mobile team needed authentication, analytics, push notifications, crash reporting, remote config, and cloud messaging without building every service from scratch. OpenGridLabs integrated Firebase into the app architecture with governance, environment separation, and release monitoring."
					...
					details={[
						{ label: "Sector", value: "Mobile SaaS and consumer app platform (anonymised)" },
						{ label: "Scope", value: "6 Firebase services integrated" },
						{ label: "Timeline", value: "7 weeks to production" },
						{ label: "Stack", value: "Firebase · Auth · Analytics · Crashlytics" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/firebase-integration/1.jpg",
						"/images/case-studies/firebase-integration/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Firebase Integration?"
					definitionText="Firebase Integration is a mobile application capability focused on improving how users access, interact with, or rely on a mobile product. In production, it requires platform-aware design, app architecture, device integration, API reliability, testing, release management, and analytics."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs unified backend services under a governed Firebase mobile implementation structure."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Firebase Integration Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made firebase integration feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."}
				...
				<CaseStudyCta 
					title={"Ready to improve your mobile application with Firebase Integration?"}
					description={"OpenGridLabs designs and builds mobile application systems for firebase integration, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support."}
