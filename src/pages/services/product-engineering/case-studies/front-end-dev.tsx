...
const STATS = [
	{ value: "22", label: "Reusable frontend components shipped", accent: "from-blue-400 to-indigo-500" },
	{ value: "35%", label: "Faster feature delivery on rebuilt workflows", accent: "from-cyan-400 to-blue-500" },
	{ value: "44%", label: "Reduction in UI defect reports", accent: "from-purple-500 to-pink-500" },
	{ value: "9 wk", label: "From UI debt to maintainable frontend", accent: "from-emerald-400 to-teal-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Reusable components", before: "One-off UI", after: "22 components", change: "Standardized" },
	{ metric: "Feature delivery speed", before: "Baseline", after: "1.35x faster", change: "Faster" },
	{ metric: "UI defects", before: "Baseline", after: "56% of baseline", change: "-44%" },
	{ metric: "Interaction analytics", before: "Partial", after: "Event-ready components", change: "Improved" },
	{ metric: "Frontend documentation", before: "Sparse", after: "Component usage guide", change: "Maintainable" }
];
...
const FAQS = [
	{
		q: "What is Front-End Dev?",
		a: "Front-End Dev is a web application capability focused on improving a specific part of the digital product experience, engineering foundation, or operational workflow. It can include design, frontend engineering, integrations, performance, security, analytics, and release practices depending on the product need."
	},
	{
		q: "Why do companies invest in Front-End Dev?",
		a: "Companies invest in Front-End Dev to improve user experience, speed up delivery, reduce technical debt, increase conversion, improve maintainability, and make the application easier to operate at scale. The strongest results come when product, design, engineering, and analytics work together."
	}
];

export default function FrontEndDevCaseStudy() {
	return (
		<>
			<SEO
				title="Front-End Dev Case Study | OpenGridLabs"
				description="How OpenGridLabs rebuilt a SaaS product interface with reusable components and clean state handling to reduce UI defects by 44%."
				canonical="/services/product-engineering/front-end-dev"
				keywords="Front-End Dev, Frontend Development, UI Engineering, Component Library, Web App Frontend, JavaScript Development, Frontend QA, Product Engineering"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Front-End Dev Rebuilt the Product Interface for Faster Releases and Cleaner UX"
					description="A product team needed frontend development that could support rapid feature delivery without accumulating more UI debt. OpenGridLabs rebuilt key interfaces with reusable components, cleaner state handling, stronger QA, and analytics-ready interactions."
					...
					details={[
						{ label: "Sector", value: "SaaS product engineering (anonymised)" },
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Front-End Dev that could move beyond isolated fixes and become part of a reliable web application strategy. OpenGridLabs designed the product workflow, frontend architecture, delivery process, quality controls, and operational monitoring needed to make the improvement stick.",
						"Front-End Dev is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Front-End Dev?"
					definitionText="Front-End Dev is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs built a modern component system to eliminate frontend UI debt."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Front-End Dev Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made front-end dev feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with Front-End Dev?"}
					description={"OpenGridLabs designs and builds web application systems for front-end dev, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
