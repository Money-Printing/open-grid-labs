					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How GPS & Maps Improved Field Workflows With Location-Aware Mobile Features
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A field operations app needed reliable location capture, route context, geofencing, and map-based task visibility. OpenGridLabs built GPS and maps features with permission handling, offline-friendly location caching, map overlays, and backend sync.
							</p>
						</motion.div>
							...
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Field service and logistics operations (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">6 location workflows launched</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">GPS · Maps SDK · Geofencing · Location Sync</span>
									</div>
								</div>
							</div>
						</motion.div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs built reliable GPS and map-based workflows for field operations.
						</p>
					</div>
						...
						{PHASES.map((phase, idx) => (
							...
							>
								<div 
									...
									style={{ backgroundImage: `linear-gradient(to right, ${idx === 0 ? "hsl(160,100%,45%)" : idx === 1 ? "hsl(180,100%,45%)" : "hsl(200,100%,50%)"}, transparent)` }}
								/>
								<div className="space-y-6">
					...
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The work made gps & maps feel like part of a real mobile product system. We got cleaner UX, fewer release surprises, and the visibility we needed to keep improving after launch."
							</p>
					...
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						...
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							...
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to build location-aware mobile features?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs and builds mobile application systems for gps & maps, combining product strategy, mobile UX, app architecture, device integrations, QA, analytics, and release support.
							</p>
