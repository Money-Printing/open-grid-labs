...
const STATS = [
	{ value: "4", label: "Offline-capable workflows launched", accent: "from-blue-400 to-indigo-500" },
	{ value: "71%", label: "Reduction in failed task submissions under poor connectivity", accent: "from-cyan-400 to-blue-500" },
	{ value: "29%", label: "Increase in mobile task completion", accent: "from-purple-500 to-pink-500" },
	{ value: "10 wk", label: "From mobile web app to PWA release", accent: "from-emerald-400 to-teal-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Offline workflows", before: "Online-only", after: "4 workflows", change: "Enabled" },
	{ metric: "Failed submissions", before: "Baseline", after: "29% of baseline", change: "-71%" },
	{ metric: "Mobile task completion", before: "Baseline", after: "1.29x baseline", change: "+29%" },
	{ metric: "Installable experience", before: "None", after: "PWA install prompt", change: "New capability" },
	{ metric: "Sync reliability", before: "Manual retry", after: "Background sync", change: "Improved" }
];
...
const FAQS = [
	{
		...
		a: "Progressive Web App is a web application capability focused on improving a specific part of the digital product experience, engineering foundation, or operational workflow. It can include design, frontend engineering, integrations, performance, security, analytics, and release practices depending on the product need."
	},
	{
		q: "Why do companies invest in Progressive Web App?",
		a: "Companies invest in Progressive Web App to improve user experience, speed up delivery, reduce technical debt, increase conversion, improve maintainability, and make the application easier to operate at scale. The strongest results come when product, design, engineering, and analytics work together."
	}
];

export default function ProgressiveWebAppCaseStudy() {
	return (
		<>
			<SEO
				title="Progressive Web App Case Study | OpenGridLabs"
				description="How OpenGridLabs built a progressive web app with offline support, caching, and background sync to reduce failed task submissions by 71%."
				canonical="/services/product-engineering/progressive-web-app"
				keywords="Progressive Web App, PWA Development, Offline Web App, Service Worker, Background Sync, Mobile Web App, Installable Web App, Web App Reliability"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How a Progressive Web App Delivered App-Like Reliability Without an App Store Install"
					description="A field operations team needed a web experience that worked under weak connectivity and felt closer to a native app. OpenGridLabs built a progressive web app with installability, offline support, caching, background sync, and mobile-first interactions."
					...
					details={[
						{ label: "Sector", value: "Field operations and service workflow (anonymised)" },
						{ label: "Scope", value: "4 offline workflows launched" },
						{ label: "Timeline", value: "10 weeks to production" },
						{ label: "Stack", value: "PWA · Service Worker · Offline Cache · Background Sync" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/progressive-web-app/1.jpg",
						"/images/case-studies/progressive-web-app/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Progressive Web App that could move beyond isolated fixes and become part of a reliable web application strategy. OpenGridLabs designed the product workflow, frontend architecture, delivery process, quality controls, and operational monitoring needed to make the improvement stick.",
						"Progressive Web App is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is a Progressive Web App?"
					definitionText="Progressive Web App is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs built a progressive web app to address critical usability and connectivity challenges."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Progressive Web App Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made progressive web app feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to build a production-ready Progressive Web App?"}
					description={"OpenGridLabs designs and builds web application systems for progressive web app, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
