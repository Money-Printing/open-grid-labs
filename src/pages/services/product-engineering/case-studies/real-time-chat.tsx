...
const STATS = [
	{ value: "3", label: "Real-time chat workflows launched", accent: "from-blue-400 to-indigo-500" },
	{ value: "36%", label: "Reduction in email-based support handoffs", accent: "from-cyan-400 to-blue-500" },
	{ value: "92%", label: "Message delivery success during monitored rollout", accent: "from-purple-500 to-pink-500" },
	{ value: "10 wk", label: "From external messaging to in-app chat", accent: "from-emerald-400 to-teal-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Chat workflows", before: "Email handoffs", after: "3 workflows", change: "Launched" },
	{ metric: "Email-based handoffs", before: "Baseline", after: "64% of baseline", change: "-36%" },
	{ metric: "Message delivery success", before: "Unmeasured", after: "92% monitored success", change: "Measured" },
	{ metric: "Permissions and moderation", before: "Manual policy", after: "Built-in controls", change: "Safer" },
	{ metric: "Conversation analytics", before: "Limited", after: "Chat dashboard", change: "Visible" }
];
...
const FAQS = [
	{
		q: "What is Real-Time Chat?",
		a: "Real-Time Chat is a web application capability focused on improving a specific part of the digital product experience, engineering foundation, or operational workflow. It can include design, frontend engineering, integrations, performance, security, analytics, and release practices depending on the product need."
	},
	{
		q: "Why do companies invest in Real-Time Chat?",
		a: "Companies invest in Real-Time Chat to improve user experience, speed up delivery, reduce technical debt, increase conversion, improve maintainability, and make the application easier to operate at scale. The strongest results come when product, design, engineering, and analytics work together."
	}
];

export default function RealTimeChatCaseStudy() {
	return (
		<>
			<SEO
				title="Real-Time Chat Case Study | OpenGridLabs"
				description="How OpenGridLabs built a real-time secure messaging system inside a customer portal to reduce email handoffs by 36%."
				canonical="/services/product-engineering/real-time-chat"
				keywords="Real-Time Chat, WebSockets, In-App Messaging, Chat Application, Presence System, Notifications, Customer Chat, Realtime Web App"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Real-Time Chat Launched Secure Messaging Inside a Customer Workflow"
					description="A customer operations team needed real-time messaging inside its web application instead of forcing users into email and external tools. OpenGridLabs built a real-time chat workflow with presence, permissions, message history, notifications, moderation controls, and analytics."
					...
					details={[
						{ label: "Sector", value: "Customer portal and support operations (anonymised)" },
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Real-Time Chat that could move beyond isolated fixes and become part of a reliable web application strategy. OpenGridLabs designed the product workflow, frontend architecture, delivery process, quality controls, and operational monitoring needed to make the improvement stick.",
						"Real-Time Chat is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Real-Time Chat?"
					definitionText="Real-Time Chat is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs built real-time communication modules to eliminate fragmented communications."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Real-Time Chat Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made real-time chat feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with Real-Time Chat?"}
					description={"OpenGridLabs designs and builds web application systems for real-time chat, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
