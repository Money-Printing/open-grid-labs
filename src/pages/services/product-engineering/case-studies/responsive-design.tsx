...
const STATS = [
	{ value: "28", label: "Responsive states validated across key screens", accent: "from-blue-400 to-indigo-500" },
	{ value: "24%", label: "Increase in mobile conversion on priority journey", accent: "from-cyan-400 to-blue-500" },
	{ value: "39%", label: "Reduction in mobile usability issues", accent: "from-purple-500 to-pink-500" },
	{ value: "6 wk", label: "From desktop-first UI to responsive release", accent: "from-emerald-400 to-teal-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Responsive states", before: "Partial", after: "28 validated states", change: "Covered" },
	{ metric: "Mobile conversion", before: "Baseline", after: "1.24x baseline", change: "+24%" },
	{ metric: "Mobile usability issues", before: "Baseline", after: "61% of baseline", change: "-39%" },
	{ metric: "Touch target compliance", before: "Inconsistent", after: "Standardized controls", change: "Improved" },
	{ metric: "Cross-device QA", before: "Manual spot checks", after: "Device matrix", change: "Reliable" }
];
...
const FAQS = [
	{
		...
		a: "Responsive Design is a web application capability focused on improving a specific part of the digital product experience, engineering foundation, or operational workflow. It can include design, frontend engineering, integrations, performance, security, analytics, and release practices depending on the product need."
	},
	{
		q: "Why do companies invest in Responsive Design?",
		a: "Companies invest in Responsive Design to improve user experience, speed up delivery, reduce technical debt, increase conversion, improve maintainability, and make the application easier to operate at scale. The strongest results come when product, design, engineering, and analytics work together."
	}
];

export default function ResponsiveDesignCaseStudy() {
	return (
		<>
			<SEO
				title="Responsive Design Case Study | OpenGridLabs"
				description="How OpenGridLabs redesigned the web experience with responsive layouts to increase mobile conversion by 24%."
				canonical="/services/product-engineering/responsive-design"
				keywords="Responsive Design, Mobile Web Design, Adaptive Layouts, Web Accessibility, Mobile UX, Cross Device QA, Frontend Design, Responsive UI"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Responsive Design Improved Mobile Conversion Across Critical User Journeys"
					description="A web application had desktop-first screens that broke down on mobile and tablet workflows. OpenGridLabs redesigned the responsive experience with flexible layouts, touch-friendly controls, and device-specific QA across key conversion paths."
					...
					details={[
						{ label: "Sector", value: "Consumer web platform and SaaS portal (anonymised)" },
						{ label: "Scope", value: "28 responsive breakpoints validated" },
						{ label: "Timeline", value: "6 weeks to launch" },
						{ label: "Stack", value: "Responsive UI · Mobile QA · Design System · Accessibility" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/responsive-design/1.jpg",
						"/images/case-studies/responsive-design/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Responsive Design that could move beyond isolated fixes and become part of a reliable web application strategy. OpenGridLabs designed the product workflow, frontend architecture, delivery process, quality controls, and operational monitoring needed to make the improvement stick.",
						"Responsive Design is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Responsive Design?"
					definitionText="Responsive Design is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs redesigned layouts to deliver consistent across-device user experiences."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Responsive Design Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made responsive design feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with Responsive Design?"}
					description={"OpenGridLabs designs and builds web application systems for responsive design, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
