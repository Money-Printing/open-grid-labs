		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Scalable Web Ecosystems Created a Foundation for Multi-Team Product Growth"
					description="A company had several web properties, product surfaces, and team-owned modules that were drifting apart. OpenGridLabs designed a scalable web ecosystem with shared foundations, component governance, integration standards, and deployment patterns."
					...
					details={[
						{ label: "Sector", value: "Multi-product SaaS ecosystem (anonymised)" },
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs unified web properties to establish a platform for product growth."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Scalable Web Ecosystems Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made scalable web ecosystems feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with Scalable Web Ecosystems?"}
					description={"OpenGridLabs designs and builds web application systems for scalable web ecosystems, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
