		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Serverless Functions Moved Event Workloads Into Scalable Serverless Execution"
					description="A product team had background tasks and integration logic running inside a monolithic backend, creating scaling and release risk. OpenGridLabs moved event-driven workloads into serverless functions with clear triggers, retries, monitoring, and cost controls."
					...
					details={[
						...
						{ label: "Scope", value: "18 functions deployed" },
						{ label: "Timeline", value: "8 weeks to production" },
						{ label: "Stack", value: "Serverless · Event Triggers · Retries · Cloud Functions" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/serverless-functions/1.jpg",
						"/images/case-studies/serverless-functions/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Is Serverless Functions?"
					definitionText="Serverless Functions is a backend development capability focused on building reliable server-side systems, service contracts, data flows, integrations, security controls, and operational tooling. In production, it requires clear architecture, testing, observability, deployment discipline, and maintainable ownership patterns."
					definitionIcon={<Cloud className="w-6 h-6 animate-pulse" />}
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs built Serverless Functions to move events into scalable serverless runtimes."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Serverless Functions Architecture Layers"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made serverless functions feel like a real platform capability instead of a pile of backend fixes. We got clearer contracts, safer releases, and the visibility we needed to operate with confidence."}
				...
				<CaseStudyCta 
					title={"Ready to strengthen your backend with Serverless Functions?"}
					description={"OpenGridLabs designs and builds backend systems for serverless functions, combining architecture, secure service contracts, data design, integrations, testing, observability, and production rollout support."}
