...
const STATS = [
	{ value: "18", label: "Serverless functions deployed for event workloads", accent: "from-green-400 to-emerald-500" },
	{ value: "39%", label: "Reduction in backend workload spikes", accent: "from-emerald-400 to-teal-500" },
	{ value: "27%", label: "Lower operating cost for bursty jobs", accent: "from-teal-500 to-sky-500" },
	{ value: "8 wk", label: "From monolith tasks to serverless execution", accent: "from-sky-400 to-green-600" }
];
...
const TABLE_RESULTS = [
	{ metric: "Serverless functions", before: "Monolith jobs", after: "18 functions", change: "Deployed" },
	{ metric: "Workload spikes", before: "Baseline", after: "61% of baseline", change: "-39%" },
	{ metric: "Operating cost", before: "Baseline", after: "73% of baseline", change: "-27%" },
	{ metric: "Retry handling", before: "Manual reruns", after: "Managed retries", change: "Reliable" },
	{ metric: "Function monitoring", before: "Limited logs", after: "Per-function dashboards", change: "Visible" }
];
...
const FAQS = [
	{
		q: "What is Serverless Functions?",
		a: "Serverless Functions is a backend development capability that supports server-side product behavior, data processing, integrations, security, reliability, or operational workflows. It can include APIs, databases, queues, authentication, caching, storage, admin tools, and real-time infrastructure depending on the system need."
	},
	{
		q: "Why do companies invest in Serverless Functions?",
		a: "Companies invest in Serverless Functions to improve scalability, reliability, security, developer velocity, data quality, and production visibility. The strongest results come when architecture, implementation, testing, observability, and operational ownership are planned together."
	}
];

export default function ServerlessFunctionsCaseStudy() {
	...
	return (
		<>
			<SEO
				title="Serverless Functions Case Study | OpenGridLabs"
				description="How OpenGridLabs moved event-driven workloads into serverless functions with clear triggers, retries, and monitoring — reducing workload spikes by 39%."
				canonical="/services/product-engineering/serverless-functions"
				keywords="Serverless Functions, Cloud Functions, AWS Lambda, Event Driven Architecture, Backend Scalability, Serverless Backend, Function Monitoring, Cloud Automation"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
					...
					<div className="grid lg:grid-cols-12 gap-12 items-start">
						...
						>
							<div className="flex items-center gap-3">
								<span className="text-xs md:text-sm font-bold tracking-widest uppercase px-4 py-1.5 rounded-full border border-green-500/30 bg-green-500/10 text-green-400 backdrop-blur-md">
							...
							<h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground to-foreground/50">
								How Serverless Functions Moved Event Workloads Into Scalable Serverless Execution
							</h1>

							<p className="text-lg md:text-2xl font-light text-foreground/80 leading-relaxed max-w-3xl">
								A product team had background tasks and integration logic running inside a monolithic backend, creating scaling and release risk. OpenGridLabs moved event-driven workloads into serverless functions with clear triggers, retries, monitoring, and cost controls.
							</p>
						</motion.div>
						...
						>
							<div className="glass-panel p-8 rounded-[32px] border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl space-y-6">
								<div className="absolute -top-12 -right-12 w-32 h-32 blur-3xl opacity-20 pointer-events-none rounded-full bg-green-500" />
								...
								<div className="space-y-4">
									<div>
										...
										<span className="text-base font-semibold text-foreground">Event-driven SaaS and operations platform (anonymised)</span>
									</div>
									<div>
										<span className="text-xs uppercase text-muted-foreground block font-bold tracking-wider">Scope</span>
										<span className="text-base font-semibold text-foreground">18 functions deployed</span>
									</div>
									<div>
									...
									<div>
										...
										<span className="text-base font-semibold text-foreground">Serverless · Event Triggers · Retries · Cloud Functions</span>
									</div>
								</div>
							</div>
						</motion.div>
					...
					<div className="grid md:grid-cols-4 gap-6">
						{STATS.map((stat, idx) => (
							<motion.div
								...
								className="glass-panel p-8 rounded-3xl border border-black/5 dark:border-white/5 hover:border-green-500/30 transition-all duration-300 shadow-xl relative overflow-hidden group"
							>
								...
								<div className="space-y-2 relative z-10">
									<p className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-foreground via-foreground to-muted-foreground group-hover:text-green-400 transition-colors">
										{stat.value}
									</p>
					...
					<div className="grid lg:grid-cols-12 gap-12 items-stretch">
						<div className="lg:col-span-7 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl space-y-6">
							<div className="flex items-center gap-2">
								...
								<span className="text-xs md:text-sm font-bold uppercase tracking-widest text-green-400">Context</span>
							</div>
							<h2 className="text-3xl md:text-5xl font-bold uppercase tracking-tight text-foreground leading-tight">
								Background
							</h2>
							<div className="w-16 h-1 rounded-full bg-green-400" />
							...
							<p className="text-lg md:text-xl font-light leading-relaxed text-foreground/80 dark:text-foreground/70">
								The company needed Serverless Functions that could move beyond quick fixes and support real product growth. OpenGridLabs designed the backend architecture, contracts, data flows, security controls, deployment process, and observability needed to make the capability reliable in production.
							</p>
						</div>
						...
						<div className="lg:col-span-5 glass-panel p-8 md:p-12 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl flex flex-col justify-center relative overflow-hidden group">
							<div className="absolute -top-12 -right-12 w-40 h-40 blur-3xl opacity-15 pointer-events-none rounded-full bg-green-400 animate-pulse" />
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground mt-4 text-lg max-w-2xl mx-auto">
							How OpenGridLabs built Serverless Functions to move events into scalable serverless runtimes.
						</p>
					</div>
					...
					<div className="space-y-6">
						{CHALLENGES.map((challenge, idx) => (
							<motion.div 
								...
								className="glass-panel p-8 rounded-[28px] border border-black/5 dark:border-white/5 hover:border-green-500/20 transition-all duration-300 shadow-lg relative overflow-hidden"
							>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						<div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-green-400/50 to-transparent" />
						
						<div className="grid lg:grid-cols-12 gap-12 items-center">
							<div className="lg:col-span-5 space-y-6">
								<div className="flex items-center gap-2">
									<Layers className="w-5 h-5 text-green-400" />
									<span className="text-xs md:text-sm font-bold uppercase tracking-widest text-green-400">Blueprint</span>
								</div>
								<h2 className="text-3xl md:text-5xl font-bold uppercase tracking-tight text-foreground leading-tight">
									System Architecture
								</h2>
								...
								<div className="flex items-start gap-4 p-5 rounded-2xl border border-green-500/20 bg-green-500/5 text-green-300">
							...
							<div className="lg:col-span-7 space-y-4">
								<h3 className="text-xs uppercase text-muted-foreground font-bold tracking-widest mb-4 text-center lg:text-left">
									Serverless Functions Architecture Layers
								</h3>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					...
					<div className="relative border-l border-white/10 md:border-l-0 md:flex md:flex-row gap-8 space-y-12 md:space-y-0 md:justify-between items-stretch">
						<div className="hidden md:block absolute left-0 right-0 top-10 h-[2px] bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 opacity-20" />
						...
						{PHASES.map((phase, idx) => (
							...
							>
								<div 
									...
									style={{ backgroundImage: `linear-gradient(to right, ${idx === 0 ? "hsl(145,100%,40%)" : idx === 1 ? "hsl(155,100%,35%)" : "hsl(165,100%,35%)"}, transparent)` }}
								/>
								<div className="space-y-6">
									<div className="flex items-center justify-between">
										<span className="text-xs font-bold uppercase tracking-widest text-green-400 bg-green-400/10 px-3.5 py-1 rounded-full border border-green-400/20">
											{phase.number}
										</span>
									</div>
							...
							<table className="w-full text-left border-collapse">
								<thead>
									<tr className="bg-white/5 border-b border-white/10">
										...
										<th className="p-6 text-sm font-bold uppercase tracking-wider text-green-400">After</th>
								...
								<tbody>
									{TABLE_RESULTS.map((row, idx) => (
										<tr key={idx} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
											...
											<td className="p-6 text-green-400 font-bold text-base">{row.after}</td>
				...
				<section className="w-[90%] max-w-[1200px] mx-auto mt-32 relative z-10 text-center">
					<div className="glass-panel p-12 md:p-20 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
						<div className="absolute top-8 left-10 text-green-500/10 opacity-20 pointer-events-none">
						...
						<div className="space-y-8 relative z-10">
							<p className="text-xl md:text-3xl italic font-light leading-relaxed text-foreground max-w-4xl mx-auto">
								"The work made serverless functions feel like a real platform capability instead of a pile of backend fixes. We got clearer contracts, safer releases, and the visibility we needed to operate with confidence."
							</p>
							<div className="w-12 h-px bg-green-400 mx-auto" />
							<div>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					...
					<div className="grid md:grid-cols-2 gap-8">
						{SUCCESS_FACTORS.map((factor, idx) => (
							<div 
								key={idx} 
								className="glass-panel p-8 md:p-12 rounded-[32px] border border-black/5 dark:border-white/5 hover:border-green-500/20 transition-all duration-300 shadow-xl space-y-4"
							>
								<div className="flex items-center gap-3">
							...
							return (
								...
								>
									...
									>
										...
										<ChevronDown className={`w-5 h-5 text-muted-foreground transition-transform duration-300 ${isOpen ? 'rotate-180 text-green-400' : ''}`} />
									</button>
				...
				<section className="w-[90%] max-w-[1600px] mx-auto mt-32 relative z-10">
					<div className="glass-panel p-8 md:p-16 rounded-[40px] border border-black/5 dark:border-white/5 shadow-2xl text-center relative overflow-hidden">
						<div 
							className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 blur-[120px] opacity-15 rounded-full pointer-events-none bg-green-400"
						/>
						<div className="max-w-3xl mx-auto space-y-8 relative z-10">
							<Sparkles className="w-10 h-10 mx-auto text-green-400 animate-pulse" />
							<h2 className="text-3xl md:text-6xl font-bold uppercase tracking-tight text-foreground leading-none">
								Ready to strengthen your backend with Serverless Functions?
							</h2>
							<p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
								OpenGridLabs designs and builds backend systems for serverless functions, combining architecture, secure service contracts, data design, integrations, testing, observability, and production rollout support.
							</p>
							<div className="flex flex-col sm:flex-row justify-center items-center gap-4">
								<Link 
									to="/contact-us"
									className="px-8 py-4 rounded-full font-bold uppercase tracking-wider text-sm transition-all duration-300 shadow-lg text-white bg-gradient-to-r from-green-400 to-green-500 hover:shadow-green-400/20"
									style={{ boxShadow: `0 10px 30px rgba(74,222,128,0.2)` }}
								>
									Talk to our team
								</Link>
								<Link 
