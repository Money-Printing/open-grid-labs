...
const STATS = [
	{ value: "6", label: "Workflow modules rebuilt as SPA experiences", accent: "from-blue-400 to-indigo-500" },
	{ value: "53%", label: "Reduction in page-to-page wait time", accent: "from-cyan-400 to-blue-500" },
	{ value: "37%", label: "Fewer duplicate frontend code paths", accent: "from-purple-500 to-pink-500" },
	{ value: "11 wk", label: "From legacy screens to SPA rollout", accent: "from-emerald-400 to-teal-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Workflow modules", before: "Server-rendered pages", after: "6 SPA modules", change: "Rebuilt" },
	{ metric: "Page wait time", before: "Baseline", after: "47% of baseline", change: "-53%" },
	{ metric: "Duplicate frontend logic", before: "Baseline", after: "63% of baseline", change: "-37%" },
	{ metric: "Route-level analytics", before: "Limited", after: "Full event coverage", change: "Visible" },
	{ metric: "Developer velocity", before: "Slower releases", after: "Shared app shell", change: "Improved" }
];
...
const FAQS = [
	{
		q: "What is SPA Development?",
		a: "SPA Development is a web application capability focused on improving a specific part of the digital product experience, engineering foundation, or operational workflow. It can include design, frontend engineering, integrations, performance, security, analytics, and release practices depending on the product need."
	},
	{
		q: "Why do companies invest in SPA Development?",
		a: "Companies invest in SPA Development to improve user experience, speed up delivery, reduce technical debt, increase conversion, improve maintainability, and make the application easier to operate at scale. The strongest results come when product, design, engineering, and analytics work together."
	}
];

export default function SPADevelopmentCaseStudy() {
	return (
		<>
			<SEO
				title="SPA Development Case Study | OpenGridLabs"
				description="How OpenGridLabs modernized a legacy workflow into a fast single-page application, reducing page wait times by 53%."
				canonical="/services/product-engineering/spa-development"
				keywords="SPA Development, Single Page Application, Frontend Architecture, React App, Web App Development, State Management, Client Routing, API Integration"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How SPA Development Modernized a Legacy Workflow Into a Fast Single-Page Application"
					description="A product team needed a faster, app-like experience for complex dashboards and operational workflows. OpenGridLabs rebuilt the core interface as a single-page application with clean routing, state management, API integration, and performance controls."
					...
					details={[
						{ label: "Sector", value: "Operations SaaS and analytics platform (anonymised)" },
						{ label: "Scope", value: "6 workflow modules rebuilt" },
						{ label: "Timeline", value: "11 weeks to production" },
						{ label: "Stack", value: "SPA · Routing · State Management · API Layer" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/spa-development/1.jpg",
						"/images/case-studies/spa-development/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed SPA Development that could move beyond isolated fixes and become part of a reliable web application strategy. OpenGridLabs designed the product workflow, frontend architecture, delivery process, quality controls, and operational monitoring needed to make the improvement stick.",
						"SPA Development is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is SPA Development?"
					definitionText="SPA Development is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs modernized frontend structures to unblock high-speed user actions."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"SPA Development Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made SPA development feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with SPA Development?"}
					description={"OpenGridLabs designs and builds web application systems for SPA development, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
