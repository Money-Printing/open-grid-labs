		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					details={[
						{ label: "Sector", value: "B2B SaaS product platform (anonymised)" },
						{ label: "Scope", value: "14 core screens redesigned" },
						{ label: "Timeline", value: "8 weeks to launch" },
						{ label: "Stack", value: "Research · Design System · Prototypes · Usability Testing" }
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionText="UI/UX Design is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs created structured UI designs to enhance user onboarding and operations."}
