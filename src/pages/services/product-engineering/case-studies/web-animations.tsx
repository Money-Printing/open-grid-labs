...
const STATS = [
	{ value: "16", label: "Interaction patterns animated and documented", accent: "from-blue-400 to-indigo-500" },
	{ value: "27%", label: "Reduction in interaction confusion on tested flows", accent: "from-cyan-400 to-blue-500" },
	{ value: "0", label: "Performance budget regressions after launch", accent: "from-purple-500 to-pink-500" },
	{ value: "6 wk", label: "From scattered motion to animation system", accent: "from-emerald-400 to-teal-500" }
];
...
const TABLE_RESULTS = [
	{ metric: "Animated patterns", before: "Inconsistent motion", after: "16 documented patterns", change: "Standardized" },
	{ metric: "Interaction confusion", before: "Baseline", after: "73% of baseline", change: "-27%" },
	{ metric: "Performance regressions", before: "Risk present", after: "0 budget regressions", change: "Protected" },
	{ metric: "Reduced motion support", before: "Partial", after: "System-wide support", change: "Accessible" },
	{ metric: "Design handoff", before: "Ad hoc specs", after: "Motion guidelines", change: "Repeatable" }
];
...
const FAQS = [
	{
		q: "What is Web Animations?",
		a: "Web Animations is a web application capability focused on improving a specific part of the digital product experience, engineering foundation, or operational workflow. It can include design, frontend engineering, integrations, performance, security, analytics, and release practices depending on the product need."
	},
	{
		q: "Why do companies invest in Web Animations?",
		a: "Companies invest in Web Animations to improve user experience, speed up delivery, reduce technical debt, increase conversion, improve maintainability, and make the application easier to operate at scale. The strongest results come when product, design, engineering, and analytics work together."
	}
];

export default function WebAnimationsCaseStudy() {
	return (
		<>
			<SEO
				title="Web Animations Case Study | OpenGridLabs"
				description="How OpenGridLabs designed performance-safe web animations that clarified state changes and guided user attention."
				canonical="/services/product-engineering/web-animations"
				keywords="Web Animations, Motion Design, CSS Animations, Microinteractions, Frontend Animation, Accessible Motion, UI Motion, Web Performance"
			/>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How Web Animations Made Product Interactions Clearer With Performance-Safe Motion"
					description="A product team wanted richer interactions, but existing animations were inconsistent, heavy, and sometimes distracting. OpenGridLabs designed web animations that clarified state changes, guided attention, and stayed within performance and accessibility budgets."
					...
					details={[
						{ label: "Sector", value: "Product experience and design system team (anonymised)" },
						{ label: "Scope", value: "16 interaction patterns animated" },
						{ label: "Timeline", value: "6 weeks to launch" },
						{ label: "Stack", value: "Motion Design · CSS Animation · Performance Budget · Accessibility" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/web-animations/1.jpg",
						"/images/case-studies/web-animations/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					contextParagraphs={[
						...
						"The company needed Web Animations that could move beyond isolated fixes and become part of a reliable web application strategy. OpenGridLabs designed the product workflow, frontend architecture, delivery process, quality controls, and operational monitoring needed to make the improvement stick.",
						"Web Animations is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
					]}
					contextHighlightColorClass="bg-blue-400"
					contextIconColorClass="text-blue-400"
					definitionTitle="What Is Web Animations?"
					definitionText="Web Animations is a web application capability that improves how users experience, access, interact with, or operate a digital product. In production, it requires clear product goals, frontend architecture, quality assurance, analytics, performance controls, and a maintainable delivery workflow."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs designed an animation library to guide user behavior efficiently."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"Web Animations Architecture Stages"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made web animations feel like part of a mature product system instead of another one-off project. We shipped faster, understood user behavior better, and had a cleaner foundation for the next releases."}
				...
				<CaseStudyCta 
					title={"Ready to improve your web application with Web Animations?"}
					description={"OpenGridLabs designs and builds web application systems for web animations, combining product strategy, UI engineering, integrations, performance, QA, analytics, and launch support."}
