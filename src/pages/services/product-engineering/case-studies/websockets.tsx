		...
		<>
			...
			<div className="bg-background min-h-screen font-sans overflow-x-hidden relative pb-32">
				...
				<CaseStudyHero 
					...
					title="How WebSockets Enabled Real-Time Product Updates at Scale"
					description="A product needed live status changes, collaboration events, and customer-facing updates without constant polling. OpenGridLabs built a WebSockets layer with presence, rooms, authorization, reconnect logic, message ordering, and operational monitoring."
					...
					details={[
						{ label: "Sector", value: "Collaboration and customer operations platform (anonymised)" },
						{ label: "Scope", value: "6 real-time workflows launched" },
						{ label: "Timeline", value: "9 weeks to production" },
						{ label: "Stack", value: "WebSockets · Presence · Pub/Sub · Realtime Monitoring" }
					]}
				/>
				...
				<CaseStudyCarousel
					...
					images={[
						"/images/case-studies/websockets/1.jpg",
						"/images/case-studies/websockets/2.jpg"
					]}
				/>
				...
				<CaseStudyBackground 
					...
					definitionTitle="What Are WebSockets?"
					definitionText="WebSockets is a backend development capability focused on building reliable server-side systems, service contracts, data flows, integrations, security controls, and operational tooling. In production, it requires clear architecture, testing, observability, deployment discipline, and maintainable ownership patterns."
				...
				<ChallengesSolutions 
					...
					description={"How OpenGridLabs built WebSockets to enable real-time backend updates at scale."}
				...
				<CaseStudyArchitecture 
					...
					rightColumnTitle={"WebSockets Architecture Layers"}
				/>
				...
				<CaseStudyQuote 
					quote={"The work made websockets feel like a real platform capability instead of a pile of backend fixes. We got clearer contracts, safer releases, and the visibility we needed to operate with confidence."}
				...
				<CaseStudyCta 
					title={"Ready to strengthen your backend with WebSockets?"}
					description={"OpenGridLabs designs and builds backend systems for websockets, combining architecture, secure service contracts, data design, integrations, testing, observability, and production rollout support."}
