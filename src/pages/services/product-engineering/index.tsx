					...
					>
						...
						<div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
							{category.items.map((item, index) => (
								<Link key={index} to={`/services/product-engineering/${slugify(item)}`} className="block cursor-pointer">
...
export default function ServicesProductEngineering() {
	return (
		<div className="bg-background min-h-screen font-sans overflow-x-hidden">
			<SEO
				title="Product Engineering - Web, Mobile & Backend | OpenGridLabs"
