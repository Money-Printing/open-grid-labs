		...
		<>
			...
			<div className="flex flex-col gap-6">
				...
				<Card title="Intellectual Property">
					All content on this website, including text, graphics, logos, and images, is the property of PDX Work or its licensors. You may not copy, reproduce, or distribute any content without prior written permission.
				</Card>

				<Card title="Limitation of Liability">
					PDX Work is not liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use the website.
				</Card>
